...
title: Bond Futures Basis Analysis
...
domain: 商业/finance
triggers: [bond futures basis, implied repo rate, delivery option]
tags: [finance, fixed-income, bond-futures, basis-trading, ctd, implied-repo, yield-curve, mcp]
level: advanced
status: stable

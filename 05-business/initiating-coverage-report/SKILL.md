...
开工前逐项确认，缺一即暂停并向用户索取——禁止用占位假设硬写：

- T1：公司名/ticker、报告货币、关键公开来源是否可及
- T2：至少 3 年财务（或明确声明数据缺口）、会计口径
- T3：任务 2 模型路径、可比公司初选名单
- T4：T1–T3 关键数字与单位已定稿
- T5：T1–T4 产物齐全、图表编号约定

核验失败时给出「缺什么 / 为何阻塞 / 用户可提供的最小替代」，不要静默降级为摘要版报告。

...
domain: 商业/seo
triggers: [content gaps, editorial calendar, topic analysis, content opportunities]
tags: [seo, geo, content-gaps, topic-analysis, content-strategy, editorial-calendar, competitive-gap]
level: intermediate
status: stable

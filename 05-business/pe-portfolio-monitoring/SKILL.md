...
domain: 商业/finance
triggers: [portfolio company, portfolio monitoring, covenant check, portfolio update]
tags: [finance, private-equity, portfolio-monitoring, kpi, covenant, variance, board-reporting]
level: intermediate
status: stable

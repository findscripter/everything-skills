...
// Scans **/SKILL.md, rebuilds INDEX/ from frontmatter, and hard-validates:
//   required fields, unique kebab name, domain↔volume dir, no dangling 互见, no requires cycle, license.
// Outputs: INDEX/{catalog,tags,tools,graph,sources}.md + graph.json + search.json
//          + .claude-plugin/marketplace.json + {CLAUDE,AGENTS,GEMINI}.md + gemini-extension.json
...
const stamp = '> Auto-generated by scripts/build-index.mjs. Do not edit by hand.\n';
...
{
  const ctx = `<!-- Auto-generated by scripts/build-index.mjs. Do not edit by hand. -->
...
console.log('Generated INDEX/{catalog,tags,tools,graph,sources}.md + graph.json + search.json + .claude-plugin/marketplace.json + {CLAUDE,AGENTS,GEMINI}.md');

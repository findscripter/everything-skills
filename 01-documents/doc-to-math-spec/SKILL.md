...
title: DOC2MATH — Document-to-Mathematics Problem Specification
...
domain: 文书/writing
triggers: [formalize into math, extract mathematical structure, document to math spec, doc2math]
tags: [mps]
level: intermediate
status: stable

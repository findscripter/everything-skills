...
domain: 研发/frontend
triggers: [Angular, Signals, computed, effect, Zoneless, SSR, Hydration, @defer, input() output() model(), inject(), OnPush, NgOptimizedImage, v20, v21, v22]
tags: [frontend, angular, signals, standalone, zoneless, ssr, hydration, typescript]
level: intermediate
status: stable

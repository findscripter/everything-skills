...
domain: 研发/mobile
triggers: [Liquid Glass, glassEffect, GlassEffectContainer, glassEffectID, glassEffectUnion, buttonStyle(.glass), glassProminent]
tags: [swiftui, liquid glass, ios 26, apple]
level: intermediate
status: stable

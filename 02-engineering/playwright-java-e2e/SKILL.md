...
title: Playwright Java – Advanced Test Automation
...
domain: 研发/testing
triggers: [Playwright Java, ThreadLocal Page, BrowserContext, Playwright trace]
tags: [playwright, java, e2e-testing, junit5, page-object-model, allure, parallel]
level: intermediate
status: stable

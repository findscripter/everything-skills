...
domain: 研发/backend
triggers: [Neon, Neon Postgres, serverless postgres, branching, PgBouncer, Prisma Neon, Drizzle Neon, preview database, DIRECT_URL, pooler, scale-to-zero]
tags: [postgres, neon, serverless, prisma, drizzle, vercel, edge]
level: intermediate
status: stable

...
- [`cross-tool-skill-manager`](../00-meta/cross-tool-skill-manager/SKILL.md) — 跨工具技能管理：在 11 个工具间增删改技能　`通用/communication` · 进阶
...
- [`rsvp-speed-reader`](../00-meta/rsvp-speed-reader/SKILL.md) — RSVP 快速阅读器　`通用/learning` · 入门
- [`socratic-explainer`](../00-meta/socratic-explainer/SKILL.md) — 苏格拉底式启发讲解　`通用/learning` · 入门
- [`codebase-structure-protocol`](../00-meta/codebase-structure-protocol/SKILL.md) — 代码库结构记忆协议　`通用/research` · 进阶
...
- [`filesystem-context-offload`](../00-meta/filesystem-context-offload/SKILL.md) — 文件系统上下文卸载　`通用/research` · 进阶
- [`last-30-days-research`](../00-meta/last-30-days-research/SKILL.md) — 近 30 天研究：Reddit/X/Web 时效话题速成　`通用/research` · 进阶
...
- [`oss-contribution-hunter`](../00-meta/oss-contribution-hunter/SKILL.md) — 开源贡献机会挖掘（oss-contribution-hunter）　`通用/research` · 进阶
- [`research-idea-generator`](../00-meta/research-idea-generator/SKILL.md) — 研究构想生成　`通用/research` · 进阶
- [`agent-self-reflection`](../00-meta/agent-self-reflection/SKILL.md) — Agent 自我反思复盘　`通用/thinking` · 进阶
- [`algorithm-first-discipline`](../00-meta/algorithm-first-discipline/SKILL.md) — 算法先行思维纪律　`通用/thinking` · 进阶
...
- [`closed-loop-delivery`](../00-meta/closed-loop-delivery/SKILL.md) — 验收标准闭环交付　`通用/thinking` · 进阶
- [`context-budget-audit`](../00-meta/context-budget-audit/SKILL.md) — 上下文窗口预算审计（裁剪臃肿组件）　`通用/thinking` · 进阶
- [`decision-cooldown-freeze`](../00-meta/decision-cooldown-freeze/SKILL.md) — 决策冷静期锁定　`通用/thinking` · 进阶
...
- [`first-principles-assumption-auditor`](../00-meta/first-principles-assumption-auditor/SKILL.md) — 第一性原理假设审计 ~~(deprecated)~~　`通用/thinking` · 进阶
...
- [`hard-call-advisor`](../00-meta/hard-call-advisor/SKILL.md) — 艰难抉择推演顾问　`通用/thinking` · 进阶
- [`idea-darwin-evolution`](../00-meta/idea-darwin-evolution/SKILL.md) — 达尔文式创意进化　`通用/thinking` · 进阶
- [`invariant-guard-correctness`](../00-meta/invariant-guard-correctness/SKILL.md) — 契约不变式正确性守卫　`通用/thinking` · 进阶
- [`kaizen-continuous-improvement`](../00-meta/kaizen-continuous-improvement/SKILL.md) — 改善持续改进法（Kaizen）　`通用/thinking` · 进阶
- [`large-scale-math-algorithms`](../00-meta/large-scale-math-algorithms/SKILL.md) — 大规模数学算法升级　`通用/thinking` · 精通
- [`objective-to-build-blueprint`](../00-meta/objective-to-build-blueprint/SKILL.md) — 目标转施工蓝图：一句话转可执行分步计划　`通用/thinking` · 进阶
- [`parallel-agent-dispatch`](../00-meta/parallel-agent-dispatch/SKILL.md) — 并行独立任务分派　`通用/thinking` · 进阶
- [`plan-execution-checkpoints`](../00-meta/plan-execution-checkpoints/SKILL.md) — 分批执行计划与检查点　`通用/thinking` · 进阶
- [`premortem-plan-challenger`](../00-meta/premortem-plan-challenger/SKILL.md) — 事前验尸式计划挑战　`通用/thinking` · 进阶
- [`skill-router-interviewer`](../00-meta/skill-router-interviewer/SKILL.md) — 技能路由顾问：访谈式定位最合适的技能　`通用/thinking` · 入门
- [`structured-decision-framework`](../00-meta/structured-decision-framework/SKILL.md) — 结构化决策框架　`通用/thinking` · 进阶
...
- [`wiki-to-vitepress-site`](../01-documents/wiki-to-vitepress-site/SKILL.md) — Wiki 转 VitePress：Markdown 转静态文档站点　`文书/markdown` · 进阶
- [`html-animated-slides`](../01-documents/html-animated-slides/SKILL.md) — 动画 HTML 演示文稿生成　`文书/office` · 进阶
...
- [`xlsx-spreadsheet-authoring`](../01-documents/xlsx-spreadsheet-authoring/SKILL.md) — XLSX 表格制作：Excel 文件创建与格式化　`文书/office` · 进阶
...
- [`doc-to-math-spec`](../01-documents/doc-to-math-spec/SKILL.md) — 文档转数学问题规范　`文书/writing` · 进阶
...
- [`latex-paper-format-conversion`](../01-documents/latex-paper-format-conversion/SKILL.md) — LaTeX 论文格式转换　`文书/writing` · 进阶
...
- [`c4-architecture-docs`](../02-engineering/c4-architecture-docs/SKILL.md) — C4 模型架构文档自动生成　`研发/architecture` · 进阶
- [`codetour-walkthrough-builder`](../02-engineering/codetour-walkthrough-builder/SKILL.md) — CodeTour 代码导览生成 ~~(deprecated)~~　`研发/architecture` · 进阶
...
- [`legacy-framework-modernizer`](../02-engineering/legacy-framework-modernizer/SKILL.md) — 遗留系统现代化重构（框架迁移）　`研发/architecture` · 进阶
...
- [`realtime-support-chat-widget`](../02-engineering/realtime-support-chat-widget/SKILL.md) — 实时客服聊天组件系统　`研发/architecture` · 进阶
...
- [`c-language-pro`](../02-engineering/c-language-pro/SKILL.md) — C 语言高效编程与内存管理　`研发/backend` · 精通
...
- [`dwarf-debug-format-expert`](../02-engineering/dwarf-debug-format-expert/SKILL.md) — DWARF 调试格式专家　`研发/backend` · 精通
- [`elixir-otp-pro`](../02-engineering/elixir-otp-pro/SKILL.md) — Elixir/OTP 并发编程　`研发/backend` · 精通
...
- [`fp-ts-pragmatic-guide`](../02-engineering/fp-ts-pragmatic-guide/SKILL.md) — fp-ts 实用函数式编程　`研发/backend` · 进阶
- [`fp-ts-refactor`](../02-engineering/fp-ts-refactor/SKILL.md) — 命令式 TS 重构为 fp-ts　`研发/backend` · 进阶
...
- [`haskell-pro`](../02-engineering/haskell-pro/SKILL.md) — Haskell 函数式工程　`研发/backend` · 精通
...
- [`julia-scientific-pro`](../02-engineering/julia-scientific-pro/SKILL.md) — Julia 科学计算工程　`研发/backend` · 精通
...
- [`minecraft-bukkit-plugin-dev`](../02-engineering/minecraft-bukkit-plugin-dev/SKILL.md) — Minecraft 服务端插件开发　`研发/backend` · 进阶
...
- [`nextjs-supabase-auth`](../02-engineering/nextjs-supabase-auth/SKILL.md) — Next.js 与 Supabase 鉴权集成　`研发/backend` · 进阶
- [`paypal-payment-integration`](../02-engineering/paypal-payment-integration/SKILL.md) — PayPal 支付集成　`研发/backend` · 进阶
...
- [`temporal-golang-workflows`](../02-engineering/temporal-golang-workflows/SKILL.md) — Temporal Go 工作流：确定性编排与 mTLS　`研发/backend` · 精通
...
- [`app-store-release-notes`](../02-engineering/app-store-release-notes/SKILL.md) — 应用商店发版说明生成（基于 Git）　`研发/devops` · 入门
...
- [`cloud-network-engineer`](../02-engineering/cloud-network-engineer/SKILL.md) — 云网络工程　`研发/devops` · 精通
...
- [`devcontainer-claude-setup`](../02-engineering/devcontainer-claude-setup/SKILL.md) — Devcontainer 隔离开发环境搭建　`研发/devops` · 进阶
...
- [`hybrid-cloud-networking`](../02-engineering/hybrid-cloud-networking/SKILL.md) — 混合云网络连接　`研发/devops` · 进阶
...
- [`kubernetes-deployment-workflow`](../02-engineering/kubernetes-deployment-workflow/SKILL.md) — Kubernetes 部署工作流　`研发/devops` · 进阶
- [`linux-sysadmin-shell-scripts`](../02-engineering/linux-sysadmin-shell-scripts/SKILL.md) — Linux 运维脚本模板　`研发/devops` · 入门
- [`linux-system-troubleshooting`](../02-engineering/linux-system-troubleshooting/SKILL.md) — Linux 系统排障　`研发/devops` · 进阶
- [`mise-toolchain-configurator`](../02-engineering/mise-toolchain-configurator/SKILL.md) — mise 工具链配置　`研发/devops` · 进阶
...
- [`release-manager`](../02-engineering/release-manager/SKILL.md) — 发布管理与部署协调 ~~(deprecated)~~　`研发/devops` · 进阶
...
- [`turborepo-build-caching`](../02-engineering/turborepo-build-caching/SKILL.md) — Turborepo 缓存：Monorepo 本地与远程构建加速　`研发/devops` · 进阶
...
- [`angularjs-to-angular-migration`](../02-engineering/angularjs-to-angular-migration/SKILL.md) — AngularJS 到 Angular 迁移　`研发/frontend` · 进阶
- [`astro-content-sites`](../02-engineering/astro-content-sites/SKILL.md) — Astro 内容型网站构建　`研发/frontend` · 进阶
- [`avalonia-zafiro-desktop`](../02-engineering/avalonia-zafiro-desktop/SKILL.md) — Avalonia 跨平台桌面应用（Zafiro/MVVM）　`研发/frontend` · 进阶
...
- [`codebase-to-wordpress-theme`](../02-engineering/codebase-to-wordpress-theme/SKILL.md) — 代码库转 WordPress 主题　`研发/frontend` · 精通
...
- [`magic-ui-component-generator`](../02-engineering/magic-ui-component-generator/SKILL.md) — AI UI 组件多方案生成　`研发/frontend` · 进阶
- [`makepad-rust-ui`](../02-engineering/makepad-rust-ui/SKILL.md) — Makepad Rust UI 开发　`研发/frontend` · 进阶
...
- [`react-flow-node-graph-architect`](../02-engineering/react-flow-node-graph-architect/SKILL.md) — ReactFlow 节点图应用架构　`研发/frontend` · 进阶
- [`react-state-management`](../02-engineering/react-state-management/SKILL.md) — React 状态管理　`研发/frontend` · 进阶
- [`scroll-driven-web-experience`](../02-engineering/scroll-driven-web-experience/SKILL.md) — 滚动驱动沉浸式网页体验　`研发/frontend` · 进阶
...
- [`vibe-code-production-cleanup`](../02-engineering/vibe-code-production-cleanup/SKILL.md) — Vibe 代码清理：全栈应用上线前安全加固　`研发/frontend` · 进阶
...
- [`expo-router-native-ui`](../02-engineering/expo-router-native-ui/SKILL.md) — Expo Router 原生 UI 构建　`研发/mobile` · 进阶
...
- [`swiftui-liquid-glass`](../02-engineering/swiftui-liquid-glass/SKILL.md) — SwiftUI Liquid Glass：液态玻璃 API 与回退实现　`研发/mobile` · 进阶
...
- [`ai-generated-code-auditor`](../02-engineering/ai-generated-code-auditor/SKILL.md) — AI 代码审计：审查快速生成代码的结构脆弱性　`研发/review` · 进阶
...
- [`full-output-enforcement`](../02-engineering/full-output-enforcement/SKILL.md) — 完整无省略代码输出约束　`研发/review` · 入门
...
- [`llm-coding-mistake-guardrails`](../02-engineering/llm-coding-mistake-guardrails/SKILL.md) — 减少 LLM 编码常见错误的准则 ~~(deprecated)~~　`研发/review` · 进阶
...
- [`web-mock-data-hunter`](../02-engineering/web-mock-data-hunter/SKILL.md) — Mock 数据猎手：审计网页中的假数据与硬编码　`研发/review` · 进阶
...
- [`bats-shell-testing`](../02-engineering/bats-shell-testing/SKILL.md) — Bats Shell 脚本自动化测试　`研发/testing` · 进阶
...
- [`lambdatest-cross-framework-testing`](../02-engineering/lambdatest-cross-framework-testing/SKILL.md) — LambdaTest 多框架测试自动化　`研发/testing` · 进阶
- [`playwright-e2e-testing`](../02-engineering/playwright-e2e-testing/SKILL.md) — Playwright 端到端测试　`研发/testing` · 进阶
- [`playwright-java-e2e`](../02-engineering/playwright-java-e2e/SKILL.md) — Playwright Java 端到端测试　`研发/testing` · 进阶
- [`python-testing-pytest`](../02-engineering/python-testing-pytest/SKILL.md) — Python pytest 测试模式　`研发/testing` · 进阶
- [`screen-reader-a11y-testing`](../02-engineering/screen-reader-a11y-testing/SKILL.md) — 屏幕阅读器无障碍测试　`研发/testing` · 进阶
...
- [`data-strategy-review`](../03-data/data-strategy-review/SKILL.md) — 数据战略决策审查 ~~(deprecated)~~　`数据/analysis` · 进阶
...
- [`apify-multi-platform-scraper`](../03-data/apify-multi-platform-scraper/SKILL.md) — Apify 多平台 AI 数据抓取　`数据/pipeline` · 进阶
...
- [`rss-news-sentiment-engine`](../03-data/rss-news-sentiment-engine/SKILL.md) — RSS 新闻情感引擎：多源聚合与结构化简报　`数据/pipeline` · 进阶
...
- [`clickhouse-analytics-io`](../03-data/clickhouse-analytics-io/SKILL.md) — ClickHouse 查询优化与分析　`数据/sql` · 进阶
...
- [`vector-database-engineer`](../03-data/vector-database-engineer/SKILL.md) — 向量数据库工程：Pinecone/Weaviate 与语义检索　`数据/sql` · 进阶
...
- [`agent-tool-design-patterns`](../04-ai/agent-tool-design-patterns/SKILL.md) — 智能体工具设计：可被 Agent 高效调用的工具　`智能/agents` · 进阶
- [`agent-workflow-pattern-designer`](../04-ai/agent-workflow-pattern-designer/SKILL.md) — 智能体工作流模式设计　`智能/agents` · 进阶
- [`agents-md-maintainer`](../04-ai/agents-md-maintainer/SKILL.md) — AGENTS.md 代理文档创建与维护　`智能/agents` · 进阶
...
- [`hierarchical-agent-memory`](../04-ai/hierarchical-agent-memory/SKILL.md) — 分层智能体记忆：目录级上下文与省 Token　`智能/agents` · 进阶
- [`langchain-architecture`](../04-ai/langchain-architecture/SKILL.md) — LangChain 架构设计　`智能/agents` · 进阶
- [`langgraph-agent-framework`](../04-ai/langgraph-agent-framework/SKILL.md) — LangGraph 智能体编排　`智能/agents` · 进阶
- [`ledger-tasks-yylo`](../04-ai/ledger-tasks-yylo/SKILL.md) — YYLO Ledger 任务看板与依赖管理　`智能/agents` · 进阶
- [`llm-app-production-patterns`](../04-ai/llm-app-production-patterns/SKILL.md) — LLM 应用生产级模式　`智能/agents` · 精通
...
- [`pipecat-voice-assistant`](../04-ai/pipecat-voice-assistant/SKILL.md) — Pipecat 低延迟语音助手　`智能/agents` · 进阶
- [`pydantic-ai-agents`](../04-ai/pydantic-ai-agents/SKILL.md) — PydanticAI 智能体开发　`智能/agents` · 进阶
- [`quota-aware-subagent-orchestrator`](../04-ai/quota-aware-subagent-orchestrator/SKILL.md) — 配额感知子智能体编排：大型多文件任务并行　`智能/agents` · 进阶
...
- [`skill-seekers-doc-to-skill`](../04-ai/skill-seekers-doc-to-skill/SKILL.md) — 文档转技能：从网站/仓库/PDF 快速生成 AI 技能　`智能/agents` · 进阶
...
- [`agent-readiness-aeo-check`](../04-ai/agent-readiness-aeo-check/SKILL.md) — 工具 Agent 就绪度 AEO 评分　`智能/eval` · 入门
- [`agent-session-trace-audit`](../04-ai/agent-session-trace-audit/SKILL.md) — AI 编码代理会话审计（成本/失败/延迟）　`智能/eval` · 进阶
...
- [`azure-realtime-voice-ai`](../04-ai/azure-realtime-voice-ai/SKILL.md) — Azure 实时语音 AI 应用构建　`智能/model-ops` · 进阶
...
- [`mlops-model-productionizer`](../04-ai/mlops-model-productionizer/SKILL.md) — 机器学习模型生产化与 MLOps ~~(deprecated)~~　`智能/model-ops` · 进阶
- [`on-device-foundation-models`](../04-ai/on-device-foundation-models/SKILL.md) — 端侧基础模型（量化与隐私推理）　`智能/model-ops` · 进阶
- [`production-ml-engineer`](../04-ai/production-ml-engineer/SKILL.md) — 生产级 ML 系统工程　`智能/model-ops` · 精通
...
- [`faf-ai-context-format`](../04-ai/faf-ai-context-format/SKILL.md) — .faf AI 上下文格式专家　`智能/prompting` · 进阶
...
- [`prompt-governance-policy`](../04-ai/prompt-governance-policy/SKILL.md) — 提示词治理与合规　`智能/prompting` · 精通
...
- [`ai-model-knowledge-distill`](../04-ai/ai-model-knowledge-distill/SKILL.md) — 从 AI 模型蒸馏结构化领域知识　`智能/rag` · 进阶
- [`embedding-model-strategies`](../04-ai/embedding-model-strategies/SKILL.md) — 嵌入模型选型与优化　`智能/rag` · 进阶
- [`helium-news-research-mcp`](../04-ai/helium-news-research-mcp/SKILL.md) — Helium 新闻研究 MCP　`智能/rag` · 入门
...
- [`rag-clarity-gate`](../04-ai/rag-clarity-gate/SKILL.md) — RAG 入库前文档清晰度校验　`智能/rag` · 进阶
...
- [`content-emotional-arc-design`](../05-business/content-emotional-arc-design/SKILL.md) — 内容情绪弧线设计　`商业/copy` · 进阶
...
- [`psychology-conversion-copy`](../05-business/psychology-conversion-copy/SKILL.md) — 消费心理学转化文案　`商业/copy` · 进阶
...
- [`business-model-canvas-architect`](../05-business/business-model-canvas-architect/SKILL.md) — 商业模式画布构建顾问　`商业/finance` · 进阶
- [`cfo-financial-advisor`](../05-business/cfo-financial-advisor/SKILL.md) — CFO 财务顾问（单位经济与融资）　`商业/finance` · 进阶
- [`channel-economics-model`](../05-business/channel-economics-model/SKILL.md) — 渠道经济性建模　`商业/finance` · 精通
...
- [`operator-audit-review`](../05-business/operator-audit-review/SKILL.md) — Kubernetes Operator 审计复盘　`商业/finance` · 进阶
...
- [`procurement-cost-optimizer`](../05-business/procurement-cost-optimizer/SKILL.md) — 采购成本优化　`商业/finance` · 进阶
...
- [`ai-disruption-moat-analyzer`](../05-business/ai-disruption-moat-analyzer/SKILL.md) — AI 颠覆护城河分析　`商业/growth` · 进阶
- [`andreessen-vc-lens`](../05-business/andreessen-vc-lens/SKILL.md) — 安德森式风投视角评估　`商业/growth` · 进阶
...
- [`digital-product-monetization`](../05-business/digital-product-monetization/SKILL.md) — 数字产品变现策略　`商业/growth` · 进阶
...
- [`micro-saas-launcher`](../05-business/micro-saas-launcher/SKILL.md) — 微型 SaaS 快速上线　`商业/growth` · 进阶
- [`notion-template-business`](../05-business/notion-template-business/SKILL.md) — Notion 模板生意运营　`商业/growth` · 进阶
...
- [`team-culture-architect`](../05-business/team-culture-architect/SKILL.md) — 团队文化架构设计　`商业/growth` · 进阶
...
- [`buyer-persona-builder`](../05-business/buyer-persona-builder/SKILL.md) — 买家画像构建　`商业/marketing` · 进阶
...
- [`linkedin-profile-optimizer`](../05-business/linkedin-profile-optimizer/SKILL.md) — LinkedIn 个人主页优化　`商业/marketing` · 进阶
...
- [`social-share-card-hardener`](../05-business/social-share-card-hardener/SKILL.md) — 社交分享卡片加固：Open Graph 富链接预览修复　`商业/marketing` · 进阶
...
- [`partnerships-strategy-architect`](../05-business/partnerships-strategy-architect/SKILL.md) — 战略合作伙伴架构　`商业/sales` · 进阶
...
- [`seo-image-generator`](../05-business/seo-image-generator/SKILL.md) — SEO 图像生成：OG 卡片、信息图与产品视觉　`商业/seo` · 进阶
...
- [`seo-traffic-drop-forensics`](../05-business/seo-traffic-drop-forensics/SKILL.md) — SEO 流量骤降取证排查 ~~(deprecated)~~　`商业/seo` · 进阶
...
- [`magic-motion-animator`](../06-creative/magic-motion-animator/SKILL.md) — AI 动效动画生成　`创意/av` · 进阶
- [`minimax-media-cli`](../06-creative/minimax-media-cli/SKILL.md) — MiniMax 多模态生成 CLI　`创意/av` · 进阶
- [`podcast-audio-generation`](../06-creative/podcast-audio-generation/SKILL.md) — 文本生成播客音频　`创意/av` · 进阶
...
- [`google-stitch-ui-prompting`](../06-creative/google-stitch-ui-prompting/SKILL.md) — Google Stitch UI 设计：AI 界面提示词工程　`创意/design` · 进阶
- [`high-end-visual-design`](../06-creative/high-end-visual-design/SKILL.md) — 高端视觉界面设计　`创意/design` · 精通
- [`iconsax-icon-library`](../06-creative/iconsax-icon-library/SKILL.md) — Iconsax 图标库与生成　`创意/design` · 入门
- [`industrial-brutalist-ui`](../06-creative/industrial-brutalist-ui/SKILL.md) — 工业野兽派遥测 UI　`创意/design` · 进阶
- [`marketing-screenshots-playwright`](../06-creative/marketing-screenshots-playwright/SKILL.md) — 应用营销截图自动生成　`创意/design` · 进阶
- [`mermaid-diagram-expert`](../06-creative/mermaid-diagram-expert/SKILL.md) — Mermaid 图表绘制专家　`创意/design` · 入门
- [`minimalist-editorial-ui`](../06-creative/minimalist-editorial-ui/SKILL.md) — 极简编辑风界面设计　`创意/design` · 进阶
- [`spline-3d-web-integration`](../06-creative/spline-3d-web-integration/SKILL.md) — Spline 3D 集成：交互式 3D 场景嵌入网页　`创意/design` · 进阶
- [`stitch-design-system-taste`](../06-creative/stitch-design-system-taste/SKILL.md) — Stitch 设计品味：排版色彩布局动效系统生成　`创意/design` · 进阶
- [`stitch-iterative-build-loop`](../06-creative/stitch-iterative-build-loop/SKILL.md) — Stitch 迭代构建循环：自主接力式网站搭建　`创意/design` · 进阶
...
- [`web-interface-guidelines-review`](../06-creative/web-interface-guidelines-review/SKILL.md) — Web 界面准则审查：网页交互规范合规检查　`创意/design` · 进阶
...
- [`photopea-embedded-editor`](../06-creative/photopea-embedded-editor/SKILL.md) — Photopea 嵌入式编辑器集成（photopea.js）：网页内嵌图像编辑引擎　`创意/image` · 进阶
- [`slack-gif-creator`](../06-creative/slack-gif-creator/SKILL.md) — Slack 动图制作器（slack-gif-creator）　`创意/image` · 进阶
- [`unsplash-photo-integration`](../06-creative/unsplash-photo-integration/SKILL.md) — Unsplash 图库集成：免费高质量摄影图搜索接入　`创意/image` · 入门
- [`vizcom-sketch-to-render`](../06-creative/vizcom-sketch-to-render/SKILL.md) — Vizcom 草图转渲染：产品设计稿转全保真 3D　`创意/image` · 进阶
...
- [`kanban-agent-pipeline-orchestrator`](../07-productivity/kanban-agent-pipeline-orchestrator/SKILL.md) — 看板智能体流水线：Asana/Linear 自动开发编排　`协作/automation` · 精通
- [`multi-agent-orchestrator`](../07-productivity/multi-agent-orchestrator/SKILL.md) — 多智能体任务编排器　`协作/automation` · 进阶
- [`personal-tool-builder`](../07-productivity/personal-tool-builder/SKILL.md) — 自用工具构建方法论　`协作/automation` · 进阶
- [`salesforce-automation`](../07-productivity/salesforce-automation/SKILL.md) — Salesforce 自动化　`协作/automation` · 进阶
- [`technical-change-tracker`](../07-productivity/technical-change-tracker/SKILL.md) — 技术变更记录与会话交接追踪 ~~(deprecated)~~　`协作/automation` · 进阶
...
- [`decision-log-recorder`](../07-productivity/decision-log-recorder/SKILL.md) — 决策日志记录（两层记忆）　`协作/knowledge` · 进阶
...
- [`multi-project-dev-diary`](../07-productivity/multi-project-dev-diary/SKILL.md) — 开发日记系统：多项目上下文自动记录器　`协作/knowledge` · 进阶
- [`new-hire-onboarding-plan`](../07-productivity/new-hire-onboarding-plan/SKILL.md) — 新员工入职计划　`协作/knowledge` · 入门
- [`obsidian-bases-builder`](../07-productivity/obsidian-bases-builder/SKILL.md) — Obsidian Bases 数据库视图　`协作/knowledge` · 进阶
- [`obsidian-clipper-templates`](../07-productivity/obsidian-clipper-templates/SKILL.md) — Obsidian 网页剪藏模板　`协作/knowledge` · 进阶
...
- [`scrum-master-analytics`](../07-productivity/scrum-master-analytics/SKILL.md) — Scrum 敏捷教练与冲刺数据分析　`协作/knowledge` · 进阶
...
- [`chief-of-staff-ops`](../07-productivity/chief-of-staff-ops/SKILL.md) — 幕僚长运营协调　`协作/pm` · 进阶
...
- [`office-hours-facilitator`](../07-productivity/office-hours-facilitator/SKILL.md) — 答疑时间会引导（创始人六问拷问）　`协作/pm` · 进阶
...
- [`product-discovery-process`](../07-productivity/product-discovery-process/SKILL.md) — 产品探索发现流程　`协作/pm` · 进阶
...
- [`agent-plugin-audit`](../08-security/agent-plugin-audit/SKILL.md) — Agent 插件安全审计　`安全/appsec` · 进阶
...
- [`html-injection-testing`](../08-security/html-injection-testing/SKILL.md) — HTML 注入测试　`安全/appsec` · 进阶
...
- [`metasploit-framework`](../08-security/metasploit-framework/SKILL.md) — Metasploit 渗透框架　`安全/appsec` · 进阶
- [`path-traversal-testing`](../08-security/path-traversal-testing/SKILL.md) — 路径遍历漏洞利用　`安全/appsec` · 进阶
- [`pentest-lab-network-services`](../08-security/pentest-lab-network-services/SKILL.md) — 渗透实验网络服务搭建　`安全/appsec` · 入门
...
- [`security-antipattern-hook`](../08-security/security-antipattern-hook/SKILL.md) — 编码安全反模式拦截钩子 ~~(deprecated)~~　`安全/appsec` · 进阶
- [`security-diff-review`](../08-security/security-diff-review/SKILL.md) — 安全导向的差异代码审查　`安全/appsec` · 进阶
...
- [`varlock-env-secrets-guard`](../08-security/varlock-env-secrets-guard/SKILL.md) — Varlock 环境变量防护：会话中密钥零泄露管理　`安全/appsec` · 进阶
- [`agent-skill-security-scanner-v2`](../08-security/agent-skill-security-scanner-v2/SKILL.md) — 技能安全扫描：采用前检测提示注入与恶意代码　`安全/audit` · 进阶
- [`attack-tree-construction`](../08-security/attack-tree-construction/SKILL.md) — 攻击树构建与威胁路径可视化　`安全/audit` · 进阶
- [`burpsuite-project-parser`](../08-security/burpsuite-project-parser/SKILL.md) — Burp Suite 工程文件命令行解析　`安全/audit` · 进阶
...
- [`skill-ecosystem-auditor`](../08-security/skill-ecosystem-auditor/SKILL.md) — 技能生态审计：质量、安全、成本与重复检测　`安全/audit` · 进阶
...
- [`multi-framework-compliance-orchestrator`](../08-security/multi-framework-compliance-orchestrator/SKILL.md) — 多框架合规编排器（multi-framework-compliance-orchestrator） ~~(deprecated)~~　`安全/compliance` · 进阶
...
- [`defensive-malware-analyst`](../08-security/defensive-malware-analyst/SKILL.md) — 防御性恶意软件分析　`安全/ops` · 进阶
...
- [`memory-forensics`](../08-security/memory-forensics/SKILL.md) — 内存取证分析　`安全/ops` · 进阶
- [`mtls-zero-trust-config`](../08-security/mtls-zero-trust-config/SKILL.md) — mTLS 零信任配置　`安全/ops` · 进阶
...
- [`itil-service-management`](../09-verticals/itil-service-management/SKILL.md) — ITIL 服务管理顾问　`领域/edu` · 进阶
- [`moodle-external-api-dev`](../09-verticals/moodle-external-api-dev/SKILL.md) — Moodle 外部 API 开发　`领域/edu` · 进阶
- [`odoo-accounting-setup`](../09-verticals/odoo-accounting-setup/SKILL.md) — Odoo 会计配置　`领域/erp` · 进阶
- [`odoo-automated-tests`](../09-verticals/odoo-automated-tests/SKILL.md) — Odoo 自动化测试　`领域/erp` · 进阶
- [`odoo-backup-strategy`](../09-verticals/odoo-backup-strategy/SKILL.md) — Odoo 备份与恢复策略　`领域/erp` · 进阶
- [`odoo-docker-deployment`](../09-verticals/odoo-docker-deployment/SKILL.md) — Odoo Docker 生产部署　`领域/erp` · 进阶
- [`odoo-ecommerce-configurator`](../09-verticals/odoo-ecommerce-configurator/SKILL.md) — Odoo 电商与网站配置　`领域/erp` · 进阶
- [`odoo-edi-connector`](../09-verticals/odoo-edi-connector/SKILL.md) — Odoo EDI 电子数据交换　`领域/erp` · 进阶
- [`odoo-hr-payroll-setup`](../09-verticals/odoo-hr-payroll-setup/SKILL.md) — Odoo 人力与薪酬配置　`领域/erp` · 进阶
- [`odoo-inventory-optimizer`](../09-verticals/odoo-inventory-optimizer/SKILL.md) — Odoo 库存优化　`领域/erp` · 进阶
- [`odoo-manufacturing-advisor`](../09-verticals/odoo-manufacturing-advisor/SKILL.md) — Odoo 制造 MRP 规划　`领域/erp` · 进阶
- [`odoo-migration-helper`](../09-verticals/odoo-migration-helper/SKILL.md) — Odoo 模块版本迁移　`领域/erp` · 进阶
- [`odoo-module-developer`](../09-verticals/odoo-module-developer/SKILL.md) — Odoo 自定义模块开发　`领域/erp` · 进阶
- [`odoo-orm-expert`](../09-verticals/odoo-orm-expert/SKILL.md) — Odoo ORM 模式精通　`领域/erp` · 进阶
- [`odoo-performance-tuner`](../09-verticals/odoo-performance-tuner/SKILL.md) — Odoo 性能诊断与调优　`领域/erp` · 进阶
- [`odoo-purchase-workflow`](../09-verticals/odoo-purchase-workflow/SKILL.md) — Odoo 采购工作流　`领域/erp` · 进阶
- [`odoo-qweb-templates`](../09-verticals/odoo-qweb-templates/SKILL.md) — Odoo QWeb 报表与模板　`领域/erp` · 进阶
- [`odoo-rpc-api`](../09-verticals/odoo-rpc-api/SKILL.md) — Odoo JSON/XML-RPC 外部接口　`领域/erp` · 进阶
- [`odoo-sales-crm-expert`](../09-verticals/odoo-sales-crm-expert/SKILL.md) — Odoo 销售与 CRM　`领域/erp` · 进阶
- [`odoo-security-rules`](../09-verticals/odoo-security-rules/SKILL.md) — Odoo 访问控制与记录规则　`领域/erp` · 进阶
- [`odoo-shopify-integration`](../09-verticals/odoo-shopify-integration/SKILL.md) — Odoo 与 Shopify 集成　`领域/erp` · 进阶
- [`odoo-xml-views-builder`](../09-verticals/odoo-xml-views-builder/SKILL.md) — Odoo XML 视图构建　`领域/erp` · 进阶
...
- [`defi-natural-language-agent`](../09-verticals/defi-natural-language-agent/SKILL.md) — 自然语言 DeFi 链上交易代理 ~~(deprecated)~~　`领域/fintech` · 进阶
...
- [`lightning-network-architecture-review`](../09-verticals/lightning-network-architecture-review/SKILL.md) — 闪电网络架构评审　`领域/fintech` · 精通
- [`longbridge-securities-toolkit`](../09-verticals/longbridge-securities-toolkit/SKILL.md) — 长桥证券工具集：实时行情、组合与期权分析　`领域/fintech` · 进阶
...
- [`nft-erc-standards`](../09-verticals/nft-erc-standards/SKILL.md) — NFT ERC-721/1155 标准精通　`领域/fintech` · 进阶
...
- [`pakistan-payments-stack`](../09-verticals/pakistan-payments-stack/SKILL.md) — 巴基斯坦本地支付集成　`领域/fintech` · 进阶
...
- [`plaid-fintech-integration`](../09-verticals/plaid-fintech-integration/SKILL.md) — Plaid 金融数据 API 集成　`领域/fintech` · 进阶
...
- [`tax-loss-harvesting`](../09-verticals/tax-loss-harvesting/SKILL.md) — 税务亏损收割策略 ~~(deprecated)~~　`领域/fintech` · 进阶
...
- [`hardware-doc-generator`](../09-verticals/hardware-doc-generator/SKILL.md) — 硬件工程文档生成 ~~(deprecated)~~　`领域/hardware` · 进阶
...
- [`legal-policy-drafter`](../09-verticals/legal-policy-drafter/SKILL.md) — 隐私政策与法律条款起草　`领域/legal` · 进阶
...
- [`property-auction-legal-analysis`](../09-verticals/property-auction-legal-analysis/SKILL.md) — 不动产拍卖法律分析 ~~(deprecated)~~　`领域/legal` · 进阶
...
- [`hospital-it-management`](../09-verticals/hospital-it-management/SKILL.md) — 医院 IT 管理顾问　`领域/medical` · 精通
...
- [`go-playwright-automation`](../10-platform/go-playwright-automation/SKILL.md) — Playwright Go 隐身浏览器自动化　`平台/browser` · 进阶
- [`go-rod-browser-automation`](../10-platform/go-rod-browser-automation/SKILL.md) — go-rod 浏览器自动化　`平台/browser` · 进阶
- [`tavily-web-research`](../10-platform/tavily-web-research/SKILL.md) — Tavily 网络检索：搜索、抓取与内容提取　`平台/browser` · 入门
- [`x-post-to-json-fetcher`](../10-platform/x-post-to-json-fetcher/SKILL.md) — X 帖子转 JSON：推文抓取为 LLM 友好结构　`平台/browser` · 入门
- [`x-twitter-scraper-toolkit`](../10-platform/x-twitter-scraper-toolkit/SKILL.md) — X/Twitter 抓取工具：搜索、导出、发推与 DM　`平台/browser` · 进阶
- [`ai-native-cli-design`](../10-platform/ai-native-cli-design/SKILL.md) — 面向 AI 智能体的 CLI 设计规范　`平台/cli` · 进阶
- [`apify-actor-development`](../10-platform/apify-actor-development/SKILL.md) — Apify Actor 开发　`平台/cli` · 进阶
- [`apify-actorization`](../10-platform/apify-actorization/SKILL.md) — 将既有软件改造为 Apify Actor　`平台/cli` · 进阶
- [`busybox-on-windows`](../10-platform/busybox-on-windows/SKILL.md) — Windows 上运行 BusyBox UNIX 工具　`平台/cli` · 入门
- [`claude-code-settings-auditor`](../10-platform/claude-code-settings-auditor/SKILL.md) — Claude Code 设置审计：仓库权限配置推荐　`平台/cli` · 进阶
...
- [`vexor-semantic-file-search`](../10-platform/vexor-semantic-file-search/SKILL.md) — Vexor 语义文件检索：定位代码实现位置　`平台/cli` · 入门
- [`vexor-vector-cli-setup`](../10-platform/vexor-vector-cli-setup/SKILL.md) — Vexor 向量 CLI：语义文件搜索工具配置　`平台/cli` · 入门
- [`youtube-transcript-ingest`](../10-platform/youtube-transcript-ingest/SKILL.md) — YouTube 字幕抓取入库　`平台/cli` · 进阶
- [`amazon-alexa-skill-builder`](../10-platform/amazon-alexa-skill-builder/SKILL.md) — Amazon Alexa 语音技能开发（Claude + AWS）　`平台/cloud` · 进阶
...
- [`azure-container-apps-deploy`](../10-platform/azure-container-apps-deploy/SKILL.md) — Azure Container Apps 容器化部署（azd） ~~(deprecated)~~　`平台/cloud` · 进阶
- [`azure-functions-serverless`](../10-platform/azure-functions-serverless/SKILL.md) — Azure Functions 无服务器开发　`平台/cloud` · 进阶
- [`claimable-postgres-provision`](../10-platform/claimable-postgres-provision/SKILL.md) — 即用临时 Postgres 数据库　`平台/cloud` · 入门
...
- [`agentphone-voice-sms-agents`](../10-platform/agentphone-voice-sms-agents/SKILL.md) — AI 电话与短信代理（AgentPhone）　`平台/integration` · 进阶
...
- [`imessage-claude-bridge`](../10-platform/imessage-claude-bridge/SKILL.md) — iMessage 短信驱动 Claude 会话桥接 ~~(deprecated)~~　`平台/integration` · 进阶
- [`linkedin-cli-automation`](../10-platform/linkedin-cli-automation/SKILL.md) — LinkedIn CLI 自动化　`平台/integration` · 进阶
- [`n8n-workflow-patterns`](../10-platform/n8n-workflow-patterns/SKILL.md) — n8n 工作流架构模式　`平台/integration` · 进阶
- [`salesforce-apex-developer`](../10-platform/salesforce-apex-developer/SKILL.md) — Salesforce Apex 与 LWC 开发　`平台/integration` · 进阶
- [`sendblue-imessage-api`](../10-platform/sendblue-imessage-api/SKILL.md) — Sendblue 消息 API：代码收发 iMessage/SMS/RCS　`平台/integration` · 进阶
...
- [`n8n-mcp-tools-expert`](../10-platform/n8n-mcp-tools-expert/SKILL.md) — n8n-mcp 工具专家　`平台/mcp` · 进阶

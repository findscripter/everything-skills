...
| [callstackincubator/agent-skills](https://github.com/callstackincubator/agent-skills) | 1,637 | Callstack：面向 React Native 的 Agent Skills 集合。 | MIT | 多 | 仅索引 |
| [Kotlin/kotlin-agent-skills](https://github.com/Kotlin/kotlin-agent-skills) | 1,032 | Kotlin 官方：Kotlin 项目可用的 AI Agent Skills。 | Apache-2.0 | 多 | 仅索引 |
| [laravel/agent-skills](https://github.com/laravel/agent-skills) | 713 | Laravel 官方 Agent Skills（Cloud/LSP/Nightwatch 等）。 | 其他 | 多 | 仅索引 |
...
| [atlassian/forge-skills](https://github.com/atlassian/forge-skills) | 21 | Atlassian Forge 官方 Skills 插件（脚手架、审查、调试、安全） | Apache-2.0 | 6 | 仅索引 |
...
| [microsoft/hve-core](https://github.com/microsoft/hve-core) | 1,446 | 微软 Hypervelocity Engineering：面向 GitHub Copilot 的指令/提示/代理/技能组件集 | MIT | 多 | 仅索引 |
| [EpicGames/unreal-engine-skills-for-claude-code-plugin](https://github.com/EpicGames/unreal-engine-skills-for-claude-code-plugin) | 275 | Epic 官方 Unreal Editor Claude Code 插件：unreal-mcp 技能 + 30+ MCP toolset | Unknown | 约 1+ | 仅索引 |
| [matlab/agent-skills-playground](https://github.com/matlab/agent-skills-playground) | 176 | MathWorks MATLAB/Simulink Agent Skills 实验沙箱（官方 playground） | Unknown | 多 | 仅索引 |
| [slackapi/slack-skills-plugin](https://github.com/slackapi/slack-skills-plugin) | 127 | Slack 官方技能插件：Slack MCP + Developer Skills，兼容 Claude/Codex/Cursor | MIT | 多 | 仅索引 |
| [pulumi/agent-skills](https://github.com/pulumi/agent-skills) | 68 | Pulumi 官方 IaC Agent Skills：迁移/密钥/代码转换等 agentskills.io 技能 | Apache-2.0 | 多 | 仅索引 |
| [catalystbyzoho/agent-skills](https://github.com/catalystbyzoho/agent-skills) | 60 | Zoho Catalyst 官方 Agent Skills：部署就绪代码与 Zoho MCP 基础设施 | Unknown | 多 | 仅索引 |
| [huaweicloud/huaweicloud-devkit](https://github.com/huaweicloud/huaweicloud-devkit) | 47 | 华为云官方 AI 代理 DevKit：云知识技能 + KooCLI + 安全护栏 | Apache-2.0 | 多 | 仅索引 |
| [AgentEra/Agently-Skills](https://github.com/AgentEra/Agently-Skills) | 26 | Agently 框架官方 Agent Skills 集合 | Unknown | 多 | 仅索引 |
...
| [VapiAI/skills](https://github.com/VapiAI/skills) | 65 | Vapi 官方语音 AI Agent Skills（创建助手/工具/活动等），兼容 skills.sh | MIT | 0 | 仅索引 |
...
| [LeoYeAI/openclaw-master-skills](https://github.com/LeoYeAI/openclaw-master-skills) | 2,133 | OpenClaw 热门 skills 精选合集（定期更新）。 | MIT | 1211 | 仅索引 |
| [openclaw/agent-skills](https://github.com/openclaw/agent-skills) | 1,078 | OpenClaw 实用 Agent Skills 集合。 | 其他 | 多 | 仅索引 |
| [levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills) | 558 | 工程向独立 Claude/Codex skills（评审/审计/测试等）。 | MIT | 7 | 仅索引 |
| [helloianneo/awesome-claude-code-skills](https://github.com/helloianneo/awesome-claude-code-skills) | 460 | Claude Code Skills/Agents/Plugins 中文精选合集。 | 其他 | 50+ | 仅索引 |
| [claude-office-skills/skills](https://github.com/claude-office-skills/skills) | 447 | 办公场景实用 Claude Skills 精选。 | MIT | 11 | 仅索引 |
| [nuwa-skills/awesome-nuwa](https://github.com/nuwa-skills/awesome-nuwa) | 353 | Awesome list of 濂冲ú.skill 鈥?鐢ㄥコ濞茶捀棣忕殑浜虹墿鎬濈淮妗嗘灦鍚堥泦 \| Distille… | 其他 | 多 | 仅索引 |
| [lingxling/awesome-skills-cn](https://github.com/lingxling/awesome-skills-cn) | 274 | 鐑棬Skills涓枃cn瀛︿範鐗?鏁欑▼锛屾彁渚?000+Skills锛岄泦鎴恈laude skills (11w+… | MIT | 4 | 仅索引 |
| [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills) | 191 | 166 production-ready Claude AI skills organized by corporate… | MIT | 166 | 仅索引 |
| [GetBindu/awesome-claude-code-and-skills](https://github.com/GetBindu/awesome-claude-code-and-skills) | 188 | A collection of Claude Skills | Apache-2.0 | 35 | 仅索引 |
| [Epsilon617/Codex-Academic-Skills](https://github.com/Epsilon617/Codex-Academic-Skills) | 179 | A curated list of research-oriented skills usable in OpenAI Codex, cov… | MIT | 4 | 仅索引 |
| [JayZeeDesign/awesome-claude-skills](https://github.com/JayZeeDesign/awesome-claude-skills) | 169 | Agent Skills 仓库：awesome-claude-skills。 | 其他 | 多 | 仅索引 |
| [jMerta/codex-skills](https://github.com/jMerta/codex-skills) | 130 | Codex CLI skills catalog | MIT | 多 | 仅索引 |
| [GoekeLab/awesome-genomic-skills](https://github.com/GoekeLab/awesome-genomic-skills) | 97 | A curated list of awesome genomics and bioinformatics agentic skills, … | CC0-1.0 | 多 | 仅索引 |
| [Mann1988/awesome-claude-skills](https://github.com/Mann1988/awesome-claude-skills) | 65 | 馃搳 Explore high-quality Claude skills focused on business an… | MIT | 多 | 仅索引 |
| [xmm/codex-bmad-skills](https://github.com/xmm/codex-bmad-skills) | 47 | BMAD skills and workflows for OpenAI Codex (App, CLI, Web): intent-bas… | 其他 | 1 | 仅索引 |
| [RankSpotAI/awesome-seo-agent-skills](https://github.com/RankSpotAI/awesome-seo-agent-skills) | 86 | SEO / GEO / AEO 方向 Agent Skills 精选列表 | CC0-1.0 | 精选列表 | 仅索引 |
| [BENZEMA216/awesome-weread](https://github.com/BENZEMA216/awesome-weread) | 61 | 微信读书官方 Agent Skill 二创项目精选 | CC0-1.0 | 精选列表 | 仅索引 |
| [martinholovsky/SOTA-skills](https://github.com/martinholovsky/SOTA-skills) | 18 | 工程最佳实践 40+ skills（安全/云/合规/UX 文案） | CC-BY-4.0 | 40+ | 仅索引 |
| [fortunto2/solo-factory](https://github.com/fortunto2/solo-factory) | 18 | 独行项目 45 skills + 3 agents 传感器工厂 | MIT | 45 | 仅索引 |
| [mirkobozzetto/arsenal](https://github.com/mirkobozzetto/arsenal) | 15 | 跨 Pi/OMP/Codex/Claude 的便携工作流 skills 运行时 | MIT | 多 | 仅索引 |
| [dreamers-laboratory/useful-skills-playbook](https://github.com/dreamers-laboratory/useful-skills-playbook) | 13 | 生产实测 27 个 agent skills（11 类） | Apache-2.0 | 27 | 仅索引 |
| [Yila-AI/awesome-research-skills](https://github.com/Yila-AI/awesome-research-skills) | 115 | 科研论文规划/撰写/修订/润色 Agent Skills（证据与引用保全） | Apache-2.0 | 多 | 仅索引 |
| [OpenLinkSoftware/ai-agent-skills](https://github.com/OpenLinkSoftware/ai-agent-skills) | 38 | OpenLink OPAL 标准 SKILL.md 技能包与 ZIP 分发集合 | MIT | 多 | 仅索引 |
| [kesslernity/awesome-copilot-cowork-skills](https://github.com/kesslernity/awesome-copilot-cowork-skills) | 27 | Microsoft 365 Copilot Cowork 可拖放 SKILL.md（工作流+评审人设） | CC-BY-SA-4.0 | 37 | 仅索引 |
| [iliaal/whetstone](https://github.com/iliaal/whetstone) | 33 | Claude Code 插件：19 agents / 22 commands / 32 skills 开发工具箱 | MIT | 32 | 仅索引 |
| [vasilyu1983/AI-Agents-public](https://github.com/vasilyu1983/AI-Agents-public) | 87 | 生产级 Agent Skills + Custom GPT 提示词合集（Claude/Codex） | MIT | 140 | 仅索引 |
| [terrylica/cc-skills](https://github.com/terrylica/cc-skills) | 62 | Claude Code Skills/Plugins 市场：工作流、质量、DevOps 等插件包 | MIT | 41 plugins | 仅索引 |
| [frankxai/claude-skills-library](https://github.com/frankxai/claude-skills-library) | 39 | 113 个生产级 Claude Agent Skills 目录（MCP/前端/云/创作等） | MIT | 113 | 仅索引 |
| [agents-inc/skills](https://github.com/agents-inc/skills) | 24 | Agents Inc 官方 Skills 市场：按技术栈原子化 SKILL.md | MIT | 150+ | 仅索引 |
| [lidge-jun/codexclaw](https://github.com/lidge-jun/codexclaw) | 21 | OpenAI Codex 开发纪律插件：28 skills + PABCD 工作流 | MIT | 28 | 仅索引 |
| [junminhong/awesome-agent-skills](https://github.com/junminhong/awesome-agent-skills) | 17 | 精选 Agent Skills / 合集 / 工具外链目录（不托管正文） | MIT | links | 仅索引 |
| [ulises-jeremias/agent-toolkit](https://github.com/ulises-jeremias/agent-toolkit) | 16 | 跨助手可组合 Skills/Agents/Loops 工具箱（CLI+市场） | MIT | many | 仅索引 |
| [human-avatar/skills-for-humanity](https://github.com/human-avatar/skills-for-humanity) | 223 | 171 个结构化推理方法论 Skills（决策/伦理/系统思维等），Show HN 推出 | MIT | 171 | 仅索引 |
| [irinabuht12-oss/marketing-skills](https://github.com/irinabuht12-oss/marketing-skills) | 1,221 | 48 个免费 Claude 营销技能（Ads/SEO/GEO）并配 Ryze MCP 数据连接 | Unknown | 约 48 | 仅索引 |
| [michael-denyer/pstack-claude](https://github.com/michael-denyer/pstack-claude) | 256 | Poteto pstack 工作流移植到 Claude Code/Codex/OpenCode/Gemini 的技能与插件集 | Unknown | 多 | 仅索引 |
| [BZDmathclub/bzd-math-modeling-skills](https://github.com/BZDmathclub/bzd-math-modeling-skills) | 224 | 全国大学生数学建模竞赛全流程 Agent Skills（读题/建模/自查/评审） | Unknown | 约 15 | 仅索引 |
| [fabricioctelles/skills](https://github.com/fabricioctelles/skills) | 75 | 跨 Kiro/Cursor/Windsurf/Claude/Codex 的可复用 Agent Skills 集合 | Unknown | 多 | 仅索引 |
| [Unknown-333/awesome-data-engineering-skills](https://github.com/Unknown-333/awesome-data-engineering-skills) | 17 | 数据工程（dbt/Airflow/Spark 等）Agent Skills 精选 | Unknown | 约 36 | 仅索引 |
| [naderelewa/Product-to-Prod](https://github.com/naderelewa/Product-to-Prod) | 41 | 产品管理全链路 Claude/Codex 技能与插件（PRD/路线图/GTM） | Unknown | 多 | 仅索引 |
| [ConnorGriffin/skills](https://github.com/ConnorGriffin/skills) | 20 | UI mockup/浏览器验证/Codebase Memory/worktree 等便携编码技能 | Unknown | 多 | 仅索引 |
| [codejunkie99/x-article-skills](https://github.com/codejunkie99/x-article-skills) | 21 | 研究、写作与打包 X 平台长文的 8 个 Agent Skills | Unknown | 8 | 仅索引 |
| [aka-kika/akakika-skills](https://github.com/aka-kika/akakika-skills) | 10 | 40 个面向冷静原生软件与 Agent 工作流的 SKILL.md 集合 | Unknown | 40 | 仅索引 |
| [ommakes/Skills](https://github.com/ommakes/Skills) | 20 | 产品设计向 Claude Skills 集合 | Unknown | 多 | 仅索引 |
| [fdiblen/rseng-agent-skills](https://github.com/fdiblen/rseng-agent-skills) | 10 | 研究软件工程（RSEng）向 AI coding agents 技能包 | Unknown | 多 | 仅索引 |
| [62656456/ai-film-skills](https://github.com/62656456/ai-film-skills) | 11 | 影视脚本/分镜/提示词等 19 个独立 Agent Skills | Unknown | 19 | 仅索引 |
| [dubzeb/awesome-gemini-spark-prompts](https://github.com/dubzeb/awesome-gemini-spark-prompts) | 19 | Gemini/Gems/Workspace 提示与 skills 规格精选 | Unknown | 精选 | 仅索引 |
| [alebgl77/claude-inc](https://github.com/alebgl77/claude-inc) | 14 | 虚拟公司式 Claude Code：8 部门与 54 份技能手册 | MIT | 约 54 | 仅索引 |
| [infranodus/skills](https://github.com/infranodus/skills) | 118 | InfraNodus 洞见生成配套的 LLM 思维增强 Skills | Unknown | 多 | 仅索引 |
...
| [almendili/skills](https://github.com/almendili/skills) | 382 | 可移植 SKILL.md 技能包（含 architecture-map 等） | Unknown | 约 1+ | 仅索引 |
| [aapersh/strategy-skills-for-claude](https://github.com/aapersh/strategy-skills-for-claude) | 313 | 21 个战略咨询独立 Claude Skills（六大咨询域） | Unknown | 约 21 | 仅索引 |
| [Misaka-Mikoto-Tech/agent-skills](https://github.com/Misaka-Mikoto-Tech/agent-skills) | 261 | Codex 向可复用 Agent Skills（含安全 PowerShell 等） | Unknown | 约 7 | 仅索引 |
| [yonatangross/orchestkit](https://github.com/yonatangross/orchestkit) | 229 | Claude Code 完整开发工具包：约 107 skills / 36 agents / 171 hooks | MIT | 约 107 | 仅索引 |
| [YiShu5/claude-skills](https://github.com/YiShu5/claude-skills) | 83 | 产品/内容/写作/演示与工作流自动化实战编码代理技能 | Unknown | 多 | 仅索引 |
| [lovstudio/skills](https://github.com/lovstudio/skills) | 65 | Lovstudio Claude Code 技能生态总索引（CJK/文档转换等） | Unknown | 多 | 仅索引 |
...
| [mikiarlo3/awesome-growth-hacking-skills](https://github.com/mikiarlo3/awesome-growth-hacking-skills) | 709 | 精选增长黑客/营销 Agent Skills 目录（enso.bot 策展），按策略、获客、内容、RevOps 等分类 | MIT | 0 | 仅索引 |
| [scarletkc/agents](https://github.com/scarletkc/agents) | 213 | 跨代理共享标准与可复用 skills（AGENTS.md + SKILL.md），面向 Claude Code / Codex CLI | Apache-2.0 | 0 | 仅索引 |
| [serpro69/claude-toolbox](https://github.com/serpro69/claude-toolbox) | 149 | 精简多语言 Claude Code 配置与插件工具箱：MCP、skills、agents 等生产向工作流 | Other | 0 | 仅索引 |
| [simota/agent-skills](https://github.com/simota/agent-skills) | 77 | 90 个专科 AI agents + Nexus 编排的跨平台技能集合（Claude/Codex/Antigravity） | MIT | 90 | 仅索引 |
| [tmchow/agent-skills](https://github.com/tmchow/agent-skills) | 64 | 个人跨平台 Agent Skills 集合，可通过 npx skills 安装到 Claude/Cursor/Codex 等 | MIT | 0 | 仅索引 |
| [eai-org/agent-toolkit](https://github.com/eai-org/agent-toolkit) | 46 | 项目无关的工程 Agent Skills/规则工具包：文档压缩、技能创作与日常工程任务 | MIT | 0 | 仅索引 |
| [antonbabenko/agent-plugins](https://github.com/antonbabenko/agent-plugins) | 42 | Claude Code / Codex 插件市场与可执行纪律型 Agent Skills 集合 | MIT | 0 | 仅索引 |
| [heymegabyte/claude-skills](https://github.com/heymegabyte/claude-skills) | 21 | Emdash：面向 32+ AI 编码工具的 solo-SaaS 技能平台（一句话到 Cloudflare 部署） | MIT | 19 | 仅索引 |
| [beeyev/skills](https://github.com/beeyev/skills) | 16 | 小型 Agent Skills 集合，含 GitLab CI Handbook 等可安装技能 | MIT | 1 | 仅索引 |
| [agent-skills-hub/agent-skills-hub](https://github.com/agent-skills-hub/agent-skills-hub) | 92 | Agent Skills Hub：跨 Claude/Gemini/Cursor/Codex 等的技能注册表与 NPX 安装，约 790+ 技能。 | MIT | 约 790+ | 仅索引 |
...
| [shanraisshan/claude-code-best-practice](https://github.com/shanraisshan/claude-code-best-practice) | 65,980 | 从 vibe coding 到 agentic engineering 的 Claude Code 最佳实践指南/技能。 | MIT | 指南 | 仅索引 |
| [VoltAgent/awesome-codex-subagents](https://github.com/VoltAgent/awesome-codex-subagents) | 6,113 | 175+ Codex 子代理精选列表（13 类）。 | MIT | 175+ | 仅索引 |
| [zebbern/claude-code-guide](https://github.com/zebbern/claude-code-guide) | 4,624 | Claude Code 社区指南：安装/命令/工作流/agents/skills 与技巧。 | MIT | 指南 | 仅索引 |
| [chaseai-yt/claudex-loop](https://github.com/chaseai-yt/claudex-loop) | 2,056 | Claude Code 四阶段计划硬化：侦察/质询/Codex 对抗审查/跨模型构建。 | MIT | 循环 | 仅索引 |
| [Pluviobyte/rnskill](https://github.com/Pluviobyte/rnskill) | 1,573 | 雪踏乌云维护的 57 个 Agent Skills（内容创作+工程/效率，SKILL.md）。 | NOASSERTION | 57 | 仅索引 |
| [MageByte-Zero/spec-superflow](https://github.com/MageByte-Zero/spec-superflow) | 803 | OpenSpec+Superpowers 融合的 Spec-first AI 编程工作流插件（多平台）。 | MIT | 9 skills | 仅索引 |
| [soumatheusgomes/vibe-coding-toolkit](https://github.com/soumatheusgomes/vibe-coding-toolkit) | 681 | Vibe Coding Toolkit：Claude Code/Codex 插件+子代理+质量门禁工具包。 | MIT | 工具包 | 仅索引 |
| [nWave-ai/nWave](https://github.com/nWave-ai/nWave) | 614 | nWave：七波次门禁式 Claude Code 交付流程（人工审批节点）。 | MIT | 7 waves | 仅索引 |
| [Zhiyuan-Fan/Awesome-DeepSeek-Harness-Plugins](https://github.com/Zhiyuan-Fan/Awesome-DeepSeek-Harness-Plugins) | 562 | DeepSeek Harness (DSH) 插件/技能/工具精选目录。 | NOASSERTION | 目录 | 仅索引 |
| [tzachbon/smart-ralph](https://github.com/tzachbon/smart-ralph) | 544 | Smart Ralph：Ralph Wiggum 循环 + 结构化规格驱动的 Claude Code 插件。 | MIT | 插件 | 仅索引 |
| [oprogramadorreal/optimus-claude](https://github.com/oprogramadorreal/optimus-claude) | 74 | optimus-claude：为项目调优 Claude Code 性能的插件集合。 | MIT | 插件 | 仅索引 |
...
| [zubair-trabzada/geo-seo-claude](https://github.com/zubair-trabzada/geo-seo-claude) | 10,310 | GEO/AI 搜索优化向 Claude SEO 技能包。 | MIT | 1 | 仅索引 |
| [nicobailon/visual-explainer](https://github.com/nicobailon/visual-explainer) | 9,657 | 生成图解/幻灯/差异评审等富 HTML 的 Agent Skill。 | MIT | 10 | 仅索引 |
| [eze-is/web-access](https://github.com/eze-is/web-access) | 8,862 | 为 Claude Code 提供联网检索与浏览器能力的 skill。 | 其他 | 多 | 仅索引 |
| [ibelick/ui-skills](https://github.com/ibelick/ui-skills) | 8,164 | UI/界面构建向 Agent Skills。 | MIT | 多 | 仅索引 |
| [Master-cai/Research-Paper-Writing-Skills](https://github.com/Master-cai/Research-Paper-Writing-Skills) | 6,577 | ML/CV/NLP 论文写作技能包（适配 Codex/Claude/Gemini）。 | MIT | 多 | 仅索引 |
| [uditgoenka/autoresearch](https://github.com/uditgoenka/autoresearch) | 6,193 | Claude Autoresearch：自主迭代研究/优化 skill。 | MIT | 3 | 仅索引 |
| [zLanqing/codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) | 3,580 | 面向中文科研：文献阅读/论文写作/科学计算 Skills（Claude+Codex）。 | MIT | 3 | 仅索引 |
| [op7418/Claude-to-IM-skill](https://github.com/op7418/Claude-to-IM-skill) | 2,874 | 把 Claude Code/Codex 桥接到 Telegram/Discord 等 IM。 | MIT | 1 | 仅索引 |
| [asuojun/claude-vision-skill](https://github.com/asuojun/claude-vision-skill) | 2,267 | Claude 视觉相关 skill。 | 其他 | 1 | 仅索引 |
| [aiwithremy/claude-skills-llm-council](https://github.com/aiwithremy/claude-skills-llm-council) | 1,841 | 多模型顾问团决策 skill（LLM Council）。 | 其他 | 3 | 仅索引 |
| [adamlyttleapps/claude-skill-aso-appstore-screenshots](https://github.com/adamlyttleapps/claude-skill-aso-appstore-screenshots) | 1,711 | App Store 截图/ASO 相关 Claude skill。 | MIT | 1 | 仅索引 |
| [adamlyttleapps/claude-skill-app-onboarding-questionnaire](https://github.com/adamlyttleapps/claude-skill-app-onboarding-questionnaire) | 1,192 | 问卷式 App onboarding 设计/生成 skill。 | MIT | 1 | 仅索引 |
| [dgreenheck/webgpu-claude-skill](https://github.com/dgreenheck/webgpu-claude-skill) | 1,184 | Three.js WebGPU 开发 Claude skill。 | 其他 | 1 | 仅索引 |
| [am-will/codex-skills](https://github.com/am-will/codex-skills) | 1,028 | Codex skills 集合。 | 其他 | 多 | 仅索引 |
| [199-biotechnologies/claude-deep-research-skill](https://github.com/199-biotechnologies/claude-deep-research-skill) | 1,013 | 企业级深度研究流水线 Claude skill。 | 其他 | 1 | 仅索引 |
| [Jane-xiaoer/claude-skill-web-clone](https://github.com/Jane-xiaoer/claude-skill-web-clone) | 986 | 高保真网站克隆方法论 skill。 | MIT | 1 | 仅索引 |
| [komal-SkyNET/claude-skill-homeassistant](https://github.com/komal-SkyNET/claude-skill-homeassistant) | 955 | Home Assistant 工作流 Claude skill。 | MIT | 3 | 仅索引 |
| [simonw/claude-skills](https://github.com/simonw/claude-skills) | 928 | Claude 代码解释器 /mnt/skills 内容镜像。 | 其他 | 多 | 仅索引 |
| [sunbigfly/ppt-agent-skills](https://github.com/sunbigfly/ppt-agent-skills) | 889 | 代码驱动演示文稿生成框架与 Agent Skills。 | 其他 | 多 | 仅索引 |
| [WJZ-P/gemini-skill](https://github.com/WJZ-P/gemini-skill) | 830 | 浏览器驱动的 Gemini 绘图 MCP/skill。 | MIT | 1 | 仅索引 |
| [tfriedel/claude-office-skills](https://github.com/tfriedel/claude-office-skills) | 821 | Office 文档创建/编辑 Claude skills（PPTX/DOCX/XLSX/PDF）。 | 其他 | 多 | 仅索引 |
| [thedivergentai/GD-Agentic-Skills](https://github.com/thedivergentai/GD-Agentic-Skills) | 664 | Godot 4.7+ AI Agent 高密度技能库。 | LGPL-3.0 | 98 | 仅索引 |
| [Hao0321/claude-skill-social-post](https://github.com/Hao0321/claude-skill-social-post) | 660 | 学习风格并自动发 FB/IG/Threads 的社交发帖 skill。 | MIT | 1 | 仅索引 |
| [sleekdotdesign/agent-skills](https://github.com/sleekdotdesign/agent-skills) | 572 | 设计向 Agent Skills 集合。 | MIT | 多 | 仅索引 |
| [HoangNguyen0403/agent-skills-standard](https://github.com/HoangNguyen0403/agent-skills-standard) | 562 | 多语言/框架 Agent Skills 标准与最佳实践合集。 | MIT | 280 | 仅索引 |
| [AAASS554/codex-academic-paper-skills](https://github.com/AAASS554/codex-academic-paper-skills) | 529 | 软工论文规划与修订 Codex skills。 | MIT | 多 | 仅索引 |
| [njzjz/nsfc-agent-skills](https://github.com/njzjz/nsfc-agent-skills) | 528 | 撰写 NSFC 本子的 Agent Skills。 | 其他 | 4 | 仅索引 |
| [cosmicstack-labs/mercury-agent-skills](https://github.com/cosmicstack-labs/mercury-agent-skills) | 471 | Mercury/OpenClaw/Hermes 可复用技能注册表。 | MIT | 132 | 仅索引 |
| [alirezarezvani/claude-code-aso-skill](https://github.com/alirezarezvani/claude-code-aso-skill) | 430 | Claude Code AEO/ASO 自动化框架 skill。 | 其他 | 1 | 仅索引 |
| [chenxiachan/xhs-claude-skills](https://github.com/chenxiachan/xhs-claude-skills) | 413 | 小红书内容提取到 Obsidian 的 Claude skills。 | MIT | 4 | 仅索引 |
| [HuangYuChuh/ComfyUI_Skills_OpenClaw](https://github.com/HuangYuChuh/ComfyUI_Skills_OpenClaw) | 401 | 面向 OpenClaw/Hermes/Codex 的 ComfyUI 工作流 skills。 | MIT | 1 | 仅索引 |
| [LeoYeAI/teammate-skill](https://github.com/LeoYeAI/teammate-skill) | 257 | Distill a teammate into an AI Skill. Auto-collect Slack/Teams/GitHub d… | MIT | 7 | 仅索引 |
| [provencher/codex-skills](https://github.com/provencher/codex-skills) | 244 | Reusable skills for ChatGPT work and Codex. | MIT | 多 | 仅索引 |
| [Spark-To-Paper-Skills/paperjury-codex](https://github.com/Spark-To-Paper-Skills/paperjury-codex) | 216 | Codex-first port of PaperJury, a pre-submission CS paper review and ed… | MIT | 1 | 仅索引 |
| [Vivixiao980/xhs-cover-skill](https://github.com/Vivixiao980/xhs-cover-skill) | 183 | 灏忕孩涔﹀皝闈㈢敓鎴愬櫒 - Claude Code Skill锛屾敮鎸?8绉嶉璁鹃鏍硷紝鍛戒护琛岀洿鎺ョ敓鎴愬皬绾… | 其他 | 1 | 仅索引 |
| [Impertio-Studio/Frappe_Claude_Skill_Package](https://github.com/Impertio-Studio/Frappe_Claude_Skill_Package) | 176 | 60 deterministic Claude AI skills for Frappe Framework & ERPNext v14-v… | 其他 | 61 | 仅索引 |
| [EXboys/skilllite](https://github.com/EXboys/skilllite) | 167 | A lightweight secure Self-evolution engine built in Rust, featuring a … | MIT | 3 | 仅索引 |
| [simbajigege/book2skills](https://github.com/simbajigege/book2skills) | 159 | Create best skills based on best books | MIT | 2 | 仅索引 |
| [moonlarry/codex-paper-skills](https://github.com/moonlarry/codex-paper-skills) | 158 | Codex杩愯瑙勮寖鍙婂啓璁烘枃浣跨敤鐨勫涓猻kills | 其他 | 多 | 仅索引 |
| [proflead/codex-skills-library](https://github.com/proflead/codex-skills-library) | 141 | Codex Skills Library is a curated library of reusable Codex skills for… | 其他 | 13 | 仅索引 |
| [lokikill123/codex-token-skills](https://github.com/lokikill123/codex-token-skills) | 111 | 鈿?Cut 60-80% token cost for DeepSeek V4 Pro on Codex CLI. to… | MIT | 多 | 仅索引 |
| [rbrown101010/codex-marketing-skills](https://github.com/rbrown101010/codex-marketing-skills) | 95 | Private team repo for Codex creator and marketing skills | 其他 | 1 | 仅索引 |
| [JustSteveKing/api-skill](https://github.com/JustSteveKing/api-skill) | 82 | An opinionated agent skill that encodes production-ready patterns for … | MIT | 1 | 仅索引 |
| [grp06/useful-codex-skills](https://github.com/grp06/useful-codex-skills) | 77 | Agent Skills 仓库：useful-codex-skills。 | MIT | 多 | 仅索引 |
| [mmiani/kotlin-kmp-claude-agent-skills](https://github.com/mmiani/kotlin-kmp-claude-agent-skills) | 73 | Public AI agent skills for Kotlin Multiplatform projects, grounded in … | 其他 | 17 | 仅索引 |
| [AsyrafHussin/agent-skills](https://github.com/AsyrafHussin/agent-skills) | 72 | Skills for AI coding agents 鈥?Laravel, PHP, React, TypeScrip… | MIT | 1 | 仅索引 |
| [wangjinger1218/nsfc-skills](https://github.com/wangjinger1218/nsfc-skills) | 68 | Agent Skills 仓库：nsfc-skills。 | MIT | 多 | 仅索引 |
| [ziho7/agnes-skills](https://github.com/ziho7/agnes-skills) | 64 | Claude Code skills for Agnes AI image and video generation APIs | 其他 | 多 | 仅索引 |
| [DwDestiny/codex-visual-asset-skills](https://github.com/DwDestiny/codex-visual-asset-skills) | 60 | Codex skills for transparent image assets and animation sprite sets | MIT | 4 | 仅索引 |
| [sechiro/VRCUdonSkills-for-Codex](https://github.com/sechiro/VRCUdonSkills-for-Codex) | 58 | VRCUdonSkills-for-Codex | MIT | 1 | 仅索引 |
| [LinklyAI/linkly-ai-skills](https://github.com/LinklyAI/linkly-ai-skills) | 55 | Agent Skills for Linkly AI 鈥?search, browse, and read your l… | Apache-2.0 | 多 | 仅索引 |
| [Rylaispirit/rylai-codex-hermes-skills](https://github.com/Rylaispirit/rylai-codex-hermes-skills) | 55 | 35 portable Agent Skills for Codex, Hermes, and Claude, maintained by … | MIT | 3 | 仅索引 |
| [Job-Yang/jobbyang-ai-skills](https://github.com/Job-Yang/jobbyang-ai-skills) | 52 | Job Yang's AI Agent Skills: writing, video reading, and reusable agent… | MIT | 多 | 仅索引 |
| [zhangpeicheng8788-ux/xhs-skill](https://github.com/zhangpeicheng8788-ux/xhs-skill) | 46 | xhs-skill锛岃嚜鍔ㄥ彂甯冪瑪璁帮細鏍囬銆傛鏂囷紝閰嶅浘鍒板皬绾功 | 其他 | 5 | 仅索引 |
| [jefflester/claude-skills-supercharged](https://github.com/jefflester/claude-skills-supercharged) | 42 | A "supercharged" implementation of Claude Code Skills 鈥撀爑sin… | MIT | 3 | 仅索引 |
| [YeyeQian/codex-thesis-review-skills](https://github.com/YeyeQian/codex-thesis-review-skills) | 42 | Codex skills for master's and doctoral thesis review | MIT | 多 | 仅索引 |
| [cfh-7598/cnki-codex-skills](https://github.com/cfh-7598/cnki-codex-skills) | 34 | Codex-native CNKI skills with Playwright/CDP automation and Zotero exp… | MIT | 1 | 仅索引 |
| [Echo-aloha/asphalt-codex-skills-5](https://github.com/Echo-aloha/asphalt-codex-skills-5) | 26 | Codex Skills for version-pure PFC2D/PFC3D 5.0 asphalt-mixture modeling… | MIT | 1 | 仅索引 |
| [zx1160763849-hash/codex-cost-router-skills](https://github.com/zx1160763849-hash/codex-cost-router-skills) | 26 | Codex Cost Router Skills - preflight task routing skills for Codex to … | MIT | 多 | 仅索引 |
| [pimenov/codex-first-skills-pack](https://github.com/pimenov/codex-first-skills-pack) | 23 | 袩褍斜谢懈褔薪褘泄 锌邪泻械褌 懈薪卸械薪械褉薪褘褏 skills 写谢褟 Codex | 其他 | 8 | 仅索引 |
| [PureTokens/andrej-karpathy-skills-codex](https://github.com/PureTokens/andrej-karpathy-skills-codex) | 21 | Codex-compatible package for Forrest Chang's Karpathy coding guideline… | 其他 | 多 | 仅索引 |
| [Interstellar-code/claud-skills](https://github.com/Interstellar-code/claud-skills) | 17 | Production-ready Claude Code framework with 13 agents, 9 skills, and a… | 其他 | 10 | 仅索引 |
| [teixasalone/UnrealEngine5-Skills](https://github.com/teixasalone/UnrealEngine5-Skills) | 17 | Provide reusable workflows for Unreal Engine 5.6/5.7 to simplify Bluep… | MIT | 多 | 仅索引 |
| [oila-gmbh/skill-bill](https://github.com/oila-gmbh/skill-bill) | 16 | SkillBill packages your engineering judgment into governed skills, the… | 其他 | 1 | 仅索引 |
| [wanshuiyin/ALIGN-Agentic-Loop-Image-GeneratioN](https://github.com/wanshuiyin/ALIGN-Agentic-Loop-Image-GeneratioN) | 15 | Agentic loop image generation without diffusion or autoregressive imag… | MIT | 多 | 仅索引 |
| [yalishevant/kotlin-backend-agent-skills](https://github.com/yalishevant/kotlin-backend-agent-skills) | 15 | Agent Skills 仓库：kotlin-backend-agent-skills。 | MIT | 25 | 仅索引 |
| [av/skills](https://github.com/av/skills) | 14 | Agent skills for Claude Code, Codex, OpenCode & Cursor 鈥?aut… | MIT | 26 | 仅索引 |
| [girish6055/NanoBanana-PPT-Skills](https://github.com/girish6055/NanoBanana-PPT-Skills) | 14 | 馃帹 Generate high-quality PPTs with AI, featuring smart trans… | 其他 | 多 | 仅索引 |
| [idea2go2go/smartfolder-skill](https://github.com/idea2go2go/smartfolder-skill) | 13 | A Claude skill that turns a folder into a collaboration knowledge base… | CC-BY-4.0 | 20 | 仅索引 |
| [kanfu-panda/pdlc-skills](https://github.com/kanfu-panda/pdlc-skills) | 12 | 38 slash commands that turn Claude Code into a real PDLC wor… | MIT | 1 | 仅索引 |
| [noartem/skills](https://github.com/noartem/skills) | 12 | Collection of Agents Skill for Laravel, Vue | 其他 | 多 | 仅索引 |
| [PauloFelipeM/agent-laravel-skills](https://github.com/PauloFelipeM/agent-laravel-skills) | 12 | A structured repository for creating and maintaining Laravel Best Prac… | 其他 | 1 | 仅索引 |
| [kurone-kito/idd-skill](https://github.com/kurone-kito/idd-skill) | 11 | 馃 An automated setup kit for implementing loop engineering … | MIT | 1 | 仅索引 |
| [techjanitor/botmaker](https://github.com/techjanitor/botmaker) | 210 | Hermes Agent 专精「造专科 bot」的 skill + SOUL | MIT | 1 | 仅索引 |
| [alchaincyf/huashu-mac-use](https://github.com/alchaincyf/huashu-mac-use) | 66 | 让 Agent 操控 macOS 无 API 原生 app 的 computer-use skill | MIT | 1 | 仅索引 |
| [bangtutorial/bang-motion](https://github.com/bangtutorial/bang-motion) | 56 | 浏览器动效 / 开场片头类 Agent Skill（单页 HTML 输出） | MIT | 1 | 仅索引 |
| [wbso-ai/omarchy-plugin-security-skill](https://github.com/wbso-ai/omarchy-plugin-security-skill) | 55 | Omarchy 插件市场上架安全陷阱审查 skill | MIT | 1 | 仅索引 |
| [manavmishra/ZeroSlop](https://github.com/manavmishra/ZeroSlop) | 112 | AI 文风去味评分与本地改写 Agent Skill | MIT | 1 | 仅索引 |
| [jvogan/a-fable-of-codexes](https://github.com/jvogan/a-fable-of-codexes) | 47 | Claude 指挥并行 Codex 舰队的编排 skills | MIT | 多 | 仅索引 |
| [ultimatile/arxiv-skills](https://github.com/ultimatile/arxiv-skills) | 41 | arXiv 检索与文档构建 Claude skills | MIT | 2 | 仅索引 |
| [Servosity/msp-skills](https://github.com/Servosity/msp-skills) | 36 | MSP 工具（PSA/RMM/M365）本地优先 MCP + Skills | Apache-2.0 | 多 | 仅索引 |
| [sakhadib/IUT-Thesis-Skill-for-AI](https://github.com/sakhadib/IUT-Thesis-Skill-for-AI) | 32 | IUT 本科论文起草与维护可复用 Agent Skill | MIT | 1 | 仅索引 |
| [Daqi029/saas-onboarding-diagnosis](https://github.com/Daqi029/saas-onboarding-diagnosis) | 24 | SaaS 新用户引导 / 激活 / Aha Moment 诊断 skill | CC-BY-NC-4.0 | 1 | 仅索引 |
| [DenisSergeevitch/game-sensitivity-coach](https://github.com/DenisSergeevitch/game-sensitivity-coach) | 23 | 游戏鼠标灵敏度调校与跨游戏换算 Agent Skill | MIT | 1 | 仅索引 |
| [MohgaNabil/deutsch-lernpaket](https://github.com/MohgaNabil/deutsch-lernpaket) | 22 | 德语 B2 周练三件套 Claude skills（会话/测验/翻译） | MIT | 3 | 仅索引 |
| [Romandredan/1c-quality-gate](https://github.com/Romandredan/1c-quality-gate) | 22 | 1C:Enterprise 开发质量门禁 Claude Code 插件/skills | MIT | 多 | 仅索引 |
| [Alchemist-Jo/textbook-anything](https://github.com/Alchemist-Jo/textbook-anything) | 20 | 大学 STEM 教材讲解与连通习题生成 Agent Skill | MIT | 1 | 仅索引 |
| [MO7YW4NG/openscite](https://github.com/MO7YW4NG/openscite) | 16 | 学术 PDF 入链引用分析 Agent Skill（Scite 替代向） | MIT | 1 | 仅索引 |
| [0nicell/data-deletion-skill](https://github.com/0nicell/data-deletion-skill) | 13 | 个人数据经纪商清除与隐私请求流程 Claude skill | CC-BY-NC-SA-4.0 | 1 | 仅索引 |
| [TokenHungryMash/personalized-travel-guide-skill](https://github.com/TokenHungryMash/personalized-travel-guide-skill) | 13 | 个性化旅行手册网页生成 Agent Skill | MIT | 1 | 仅索引 |
| [kpab/seo-mastery-agent-skills](https://github.com/kpab/seo-mastery-agent-skills) | 12 | 基于官方检索文档的 SEO Agent Skills（英日） | MIT | 多 | 仅索引 |
| [Latifox/find-me-saas](https://github.com/Latifox/find-me-saas) | 10 | SaaS 点子调研 / 打分 / 枢轴分析 skills 包 | MIT | 10+ | 仅索引 |
| [kennyzir/7deer_skills](https://github.com/kennyzir/7deer_skills) | 311 | 可审计的 Roblox 游戏站增长 Agent Skills 工作流 | MIT | 15+ | 仅索引 |
| [machina-sports/sports-skills](https://github.com/machina-sports/sports-skills) | 215 | 体育数据与预测市场开源 Agent Skills（足球/F1/Kalshi 等） | MIT | 多 | 仅索引 |
| [johnpapa/ai-ready](https://github.com/johnpapa/ai-ready) | 189 | 扫描仓库并生成 AGENTS.md/Copilot/CI 等 AI-ready 配置的 Skill | MIT | 1 | 仅索引 |
| [addyosmani/clarity](https://github.com/addyosmani/clarity) | 181 | 面向更清晰写作的 Agent Skill（Clarity） | MIT | 1 | 仅索引 |
| [calesthio/generative-media-skills](https://github.com/calesthio/generative-media-skills) | 170 | 生成式图像/视频/音频制作研究型 Agent Skills 套件 | MIT | 150+ | 仅索引 |
| [kitze/council](https://github.com/kitze/council) | 169 | 强制多 Agent CLI 会商后再给计划的协作 Skill | MIT | 1 | 仅索引 |
| [guiguiyan930-source/game-ui-design-workflow](https://github.com/guiguiyan930-source/game-ui-design-workflow) | 164 | Cursor 游戏 UI 设计 Agent Skills（策划→规范→延展→拆解） | MIT | 8 | 仅索引 |
| [Blotato-Inc/blotato-skills](https://github.com/Blotato-Inc/blotato-skills) | 158 | Blotato 社媒发布 Claude Skills 插件市场（空白到排期） | NOASSERTION | 8 | 仅索引 |
| [aronhy/tiktok-agent-skills](https://github.com/aronhy/tiktok-agent-skills) | 152 | TikTok Shop 运营 Agent Skills（选品/店铺/达人/字幕+方案） | MIT | 多 | 仅索引 |
| [aleksandr-alhoff/seo-landing](https://github.com/aleksandr-alhoff/seo-landing) | 145 | 技术 SEO 落地页 Agent Skill（CWV/PageSpeed/Schema） | MIT | 1 | 仅索引 |
| [firefly-hefeng/VESTI-SKILLS](https://github.com/firefly-hefeng/VESTI-SKILLS) | 143 | VESTI 记忆与交接 Agent Skills（跨 coding agent 工作延续） | MIT | 2 | 仅索引 |
| [open-infra-skills/infra-skills](https://github.com/open-infra-skills/infra-skills) | 140 | AI 基础设施构建/运维/性能优化的便携 Agent Skills | Apache-2.0 | 多 | 仅索引 |
| [N1arko/redaktura-skills](https://github.com/N1arko/redaktura-skills) | 135 | 俄语编辑政策/文案/UX 文案 Agent Skills 套件 | NOASSERTION | 多 | 仅索引 |
| [netresearch/agent-rules-skill](https://github.com/netresearch/agent-rules-skill) | 74 | 按 agents.md 规范生成/维护 AGENTS.md 的 Agent Skill | NOASSERTION | 1 | 仅索引 |
| [getaero-io/gtm-eng-skills](https://github.com/getaero-io/gtm-eng-skills) | 55 | GTM 工程 Agent Skills（TAM、线索富化、信号、outbound） | MIT | 10 | 仅索引 |
| [yha9806/academic-writing-toolkit](https://github.com/yha9806/academic-writing-toolkit) | 36 | 证据可控的学术写作 Agent Skills（修订边界与发布治理） | MIT | 多 | 仅索引 |
| [PyModel/css-pro-tips](https://github.com/PyModel/css-pro-tips) | 21 | 面向现代 CSS Baseline 的跨 Agent 单一 SKILL.md | MIT | 1 | 仅索引 |
| [GabrielOnDelphi/Claude-Tools-for-Delphi](https://github.com/GabrielOnDelphi/Claude-Tools-for-Delphi) | 17 | Delphi 商业开发 Claude Code Skills/Agents | MPL-2.0 | 32 | 仅索引 |
| [a-attia/scicomp-research-skills](https://github.com/a-attia/scicomp-research-skills) | 11 | 科学计算科研论文与软件工作流 Agent Skills | MIT | 多 | 仅索引 |
| [HKUSTDial/Supervisor-Skills](https://github.com/HKUSTDial/Supervisor-Skills) | 6,670 | 将博导科研经验蒸馏为可执行 AI Skills（Idea评估、论文写作、审稿、作图等） | CC-BY-NC-SA-4.0 | ~12 | 仅索引 |
| [rrezartprebreza/spring-boot-skills](https://github.com/rrezartprebreza/spring-boot-skills) | 259 | Spring Boot 3/4 生产级 Claude Code & Codex Skills（含 marketplace） | MIT | 33×2 | 仅索引 |
| [techygarg/lattice](https://github.com/techygarg/lattice) | 185 | 可组合工程纪律 Skills（设计→实现→评审流水线），兼容 Claude/Codex/Cursor | MIT | atoms+molecules | 仅索引 |
| [meshy-dev/meshy-3d-agent](https://github.com/meshy-dev/meshy-3d-agent) | 88 | Meshy AI 3D 生成/打印 Agent Skills（Cursor/Claude/OpenClaw） | MIT | 3 | 仅索引 |
| [See-Sol-Lab/private-house-code-v2.5](https://github.com/See-Sol-Lab/private-house-code-v2.5) | 88 | Codex 全局编码约束 Skill：抑制过度工程与 token 浪费 | CC-BY-NC-SA-4.0 | 1–2 | 仅索引 |
| [kcchien/model-thinking](https://github.com/kcchien/model-thinking) | 75 | 心智模型思考 Agent Skill（决策/系统/统计等十大领域） | MIT | 1 | 仅索引 |
| [Desko77/cursor-1c-skills](https://github.com/Desko77/cursor-1c-skills) | 55 | Cursor 1C:Enterprise 开发 Skills/规则/命令（元数据、表单、扩展） | MIT | 115 | 仅索引 |
| [respira-press/agent-skills-wordpress](https://github.com/respira-press/agent-skills-wordpress) | 42 | WordPress 站点审计/迁移/SEO 等社区 Agent Skills 枢纽 | MIT | 20+ | 仅索引 |
| [Djarvur/go-ultimate](https://github.com/Djarvur/go-ultimate) | 22 | 意见化 Go 编程 Agent Skill（架构/测试/MCP/生产就绪） | MIT | 1 | 仅索引 |
| [geekjourneyx/geekx-skills](https://github.com/geekjourneyx/geekx-skills) | 20 | 工程裁决/追问/实现约束 Agent Skills（geekx-gate 等） | MIT | 3 | 仅索引 |
| [zhu-hailin/cumcm-modeling-analyst](https://github.com/zhu-hailin/cumcm-modeling-analyst) | 17 | CUMCM 数学建模竞赛协作 Skill（读题、求解、验证、论文） | NOASSERTION | 1 | 仅索引 |
| [aiopshwang/data-analysis-ml-agent-skills](https://github.com/aiopshwang/data-analysis-ml-agent-skills) | 12 | 证据优先的数据分析/ML Agent Skills 套件 | MIT | 7 | 仅索引 |
| [bitdezi/claude-skill-product-optimize](https://github.com/bitdezi/claude-skill-product-optimize) | 13 | 产品打磨 Skill：主动发现视觉/逻辑/代码质量问题并逐项讨论-实施-验收-提交 | MIT | 1 | 仅索引 |
| [achimala/dream-loop](https://github.com/achimala/dream-loop) | 378 | 用图像生成目标图+子代理评审闭环做高视觉质量场景的 Agent Skill | Unknown | 1 | 仅索引 |
| [daishuge/pcb-skill](https://github.com/daishuge/pcb-skill) | 78 | 从创意到可下单 PCB 的 EasyEDA MCP 驱动 Agent Skill | MIT | 1 | 仅索引 |
| [adand-91/requirement-ledger](https://github.com/adand-91/requirement-ledger) | 117 | 把纠错沉淀为可追溯需求与修复计划的隐私优先反馈 Skill | Unknown | 1 | 仅索引 |
| [gviiisen/repo-context-ledger](https://github.com/gviiisen/repo-context-ledger) | 105 | 用 Git 保存可验证功能说明，跨会话交接上下文的 Agent Skill | Unknown | 1 | 仅索引 |
| [nwiizo/oi-owarasero](https://github.com/nwiizo/oi-owarasero) | 98 | 《おい、とりあえず終わらせろ》五步收尾流程的 Claude/Codex Skill | Unknown | 1 | 仅索引 |
| [guinacio/claude-image-gen](https://github.com/guinacio/claude-image-gen) | 62 | 经 Skills/MCP 调用 Gemini/OpenAI 图像生成 | Unknown | 多 | 仅索引 |
| [KeWang0622/kaogong-skill](https://github.com/KeWang0622/kaogong-skill) | 56 | 公务员考试（行测/申论/面试）AI 辅导 Agent Skill | Unknown | 多 | 仅索引 |
| [netresearch/git-workflow-skill](https://github.com/netresearch/git-workflow-skill) | 48 | Git 分支/提交/PR 工作流最佳实践 Agent Skill | Unknown | 1 | 仅索引 |
| [netresearch/php-modernization-skill](https://github.com/netresearch/php-modernization-skill) | 44 | PHP 8.x 现代化（类型/属性/PHPStan）Agent Skill | Unknown | 1 | 仅索引 |
| [Jakeschincariol/linkedin-agent-skill](https://github.com/Jakeschincariol/linkedin-agent-skill) | 34 | 运营 LinkedIn 账号的 11 个免费 Claude Skills | Unknown | 11 | 仅索引 |
| [cth9191/motion-design](https://github.com/cth9191/motion-design) | 34 | 经 Higgsfield 改编运动设计成片的 Codex/Claude Skill | Unknown | 1 | 仅索引 |
| [CreateLafont/dnr-flat-pic](https://github.com/CreateLafont/dnr-flat-pic) | 16 | 照片转扁平矢量插画的跨平台 Agent Skill | Unknown | 1 | 仅索引 |
| [hope138/enterprise-ai-project-assessor](https://github.com/hope138/enterprise-ai-project-assessor) | 10 | 企业 AI 立项/POC/试点方案评审 Agent Skill | Unknown | 1 | 仅索引 |
| [Gracker/Perfetto-Skills](https://github.com/Gracker/Perfetto-Skills) | 25 | Android/Linux/Chromium Perfetto 证据分析便携 Skill | Unknown | 多 | 仅索引 |
| [Shehabov/pm-resume-builder-skill](https://github.com/Shehabov/pm-resume-builder-skill) | 29 | 产品经理简历 ATS 友好生成 Claude Skill | MIT | 1 | 仅索引 |
| [javen-wangjunren/elementor-website-skill](https://github.com/javen-wangjunren/elementor-website-skill) | 26 | 用可维护 Elementor 组件规划/搭建 B2B 站点的技能套件 | Unknown | 多 | 仅索引 |
| [nevertoday/xxd-strip-ai-meta](https://github.com/nevertoday/xxd-strip-ai-meta) | 26 | 批量剥离 AI 溯源与图片元数据的 CLI+Agent Skill | Unknown | 1 | 仅索引 |
| [ALLENLION35/geo-first-principles](https://github.com/ALLENLION35/geo-first-principles) | 15 | 面向企业负责人的 GEO 第一性原理分析 Skill | Unknown | 1 | 仅索引 |
| [ahmedyehya92/saas-platform-teardown-kit](https://github.com/ahmedyehya92/saas-platform-teardown-kit) | 14 | 输入 SaaS URL 输出尽调级平台拆解的 Claude Skill | Unknown | 1 | 仅索引 |
| [DogukanK/claude-pc-cleanup](https://github.com/DogukanK/claude-pc-cleanup) | 14 | macOS 磁盘清理（分级确认）Claude Skill | Unknown | 1 | 仅索引 |
| [mikefutia/ad-multiplier](https://github.com/mikefutia/ad-multiplier) | 10 | 保留镜头与成片结构仅替换出镜人的视频广告复用 Skill | Unknown | 1 | 仅索引 |
| [icesixgod/awesome-astra-blender-characters](https://github.com/icesixgod/awesome-astra-blender-characters) | 12 | Blender 角色创建/修复与九视图校验 Agent Skill | Unknown | 1 | 仅索引 |
| [QingYunA/agent-html](https://github.com/QingYunA/agent-html) | 12 | 零依赖单文件 HTML 设计系统与 Agent Skill | Unknown | 1 | 仅索引 |
| [qqyumidi/eli5-plus](https://github.com/qqyumidi/eli5-plus) | 11 | 分层可视化独立 HTML 讲解页 Agent Skill | Unknown | 1 | 仅索引 |
| [enwong93-sketch/video-to-3d](https://github.com/enwong93-sketch/video-to-3d) | 11 | 转台/多视角证据驱动的 Blender 角色重建 Skill | Unknown | 1 | 仅索引 |
| [fatdog-pro/Comsol-automatic-wwj](https://github.com/fatdog-pro/Comsol-automatic-wwj) | 11 | 真实 COMSOL 计算与 Desktop 可视化的配套 Skill/MCP 环境 | Unknown | 1 | 仅索引 |
| [Warlord-K/visual-thinking](https://github.com/Warlord-K/visual-thinking) | 20 | 视觉设计与产品视频向 Agent Skill | Unknown | 多 | 仅索引 |
| [momotarabitch2/write-in-pencil](https://github.com/momotarabitch2/write-in-pencil) | 15 | 把 UI/幻灯/图示探索成铅笔草图的 Agent Skill | Unknown | 1 | 仅索引 |
| [shir-danishyar/humanize](https://github.com/shir-danishyar/humanize) | 15 | 去除 AI 写作痕迹的双模式 Skill（含确定性检查） | Unknown | 1 | 仅索引 |
| [uxuiprinciples/agent-skills](https://github.com/uxuiprinciples/agent-skills) | 15 | 五份 UX 评估/气味检测/流程检查 SKILL.md | Unknown | 5 | 仅索引 |
| [88lin/computer-repair-skill](https://github.com/88lin/computer-repair-skill) | 11 | 跨平台电脑维修诊断 Playbook Agent Skill | Unknown | 约 62 | 仅索引 |
| [zimodzh/dsh-plugin-dev-skills](https://github.com/zimodzh/dsh-plugin-dev-skills) | 14 | 开发 DeepSeek Harness 插件的 Agent Skill 标准 | Unknown | 1 | 仅索引 |
| [mcdenil-skills/razbor-servisa](https://github.com/mcdenil-skills/razbor-servisa) | 16 | 把无 API 服务逆向成 Agent 可调用 CLI 的 Claude Skill | Unknown | 1 | 仅索引 |
...
| [EverettFish/holo-card-studio](https://github.com/EverettFish/holo-card-studio) | 1,335 | Codex Skill：一句话生成可交互 3D 全息闪卡（Blender+Three.js） | Unknown | 1 | 仅索引 |
| [kajisho5/ffmpeg-skill](https://github.com/kajisho5/ffmpeg-skill) | 936 | 本地 FFmpeg 视频编辑 Agent Skill（Claude/Cursor/Codex/MCP） | Unknown | 1 | 仅索引 |
| [larashero3-dotcom/lieflat-gongwen](https://github.com/larashero3-dotcom/lieflat-gongwen) | 739 | 102 万字语料蒸馏的中文公文写作 Skill（7 类文体） | Unknown | 1 | 仅索引 |
| [Vincentwei1021/anything2explainer](https://github.com/Vincentwei1021/anything2explainer) | 713 | 主题→Remotion 讲解视频 Skill（TTS/字幕/章节进度条） | Unknown | 1 | 仅索引 |
| [larashero3-dotcom/lieflat-less-ai-tone](https://github.com/larashero3-dotcom/lieflat-less-ai-tone) | 712 | 283 万字语料统计的去 AI 味写作 Skill | Unknown | 1 | 仅索引 |
| [jtydhr88/screenwriting-skills](https://github.com/jtydhr88/screenwriting-skills) | 568 | 编剧/剧本创作向 Agent Skills 包 | Unknown | 多 | 仅索引 |
| [carnot-tech/consulting-pptx-skill](https://github.com/carnot-tech/consulting-pptx-skill) | 434 | 咨询级 PPTX 生成 Claude Skill（62 型幻灯片规格+校验） | Unknown | 1 | 仅索引 |
| [mizzlelover/gongwen-gbt9704-skill](https://github.com/mizzlelover/gongwen-gbt9704-skill) | 335 | 按 GB/T 9704-2012 生成可编辑公文 DOCX 的跨平台 Skill | Unknown | 1 | 仅索引 |
| [vaibhavarora14/job-application-agent](https://github.com/vaibhavarora14/job-application-agent) | 145 | 隐私优先求职申请 Codex/Claude Skill（发现/填表/跟踪） | Unknown | 约 9 | 仅索引 |
| [viettranx/3dviz-pro-max](https://github.com/viettranx/3dviz-pro-max) | 136 | 创意 3D 可视化 Agent Skill（Three.js/Blender，含配方与知识库） | MIT | 1 | 仅索引 |
| [unclecatvn/agent-skills](https://github.com/unclecatvn/agent-skills) | 132 | Odoo 开发与专业工作流 AI 技能包（CLI 可装） | MIT | 多 | 仅索引 |
| [jaakla/openmapstack-skills](https://github.com/jaakla/openmapstack-skills) | 69 | 可复现 GIS 分析 Agent Skill（OSM/STAC/DuckDB/PostGIS/MapLibre） | Unknown | 多 | 仅索引 |
| [gl0bal01/malware-analysis-claude-skills](https://github.com/gl0bal01/malware-analysis-claude-skills) | 46 | 蓝队恶意软件分析 Claude Skills（分诊/动态分析/检测工程/报告） | Unknown | 约 5 | 仅索引 |
...
| [flaqai/backlink_skills](https://github.com/flaqai/backlink_skills) | 709 | Codex 驱动的外链提交与 SEO 内容生产技能包：目录提交、写作与多平台分发工作流 | MIT | 0 | 仅索引 |
| [eternityspring/reelbench-skills](https://github.com/eternityspring/reelbench-skills) | 534 | AI 视频侧 Claude/Codex 技能：成片拉片（video-shots）与分镜信息合成（video-sync） | Apache-2.0 | 2 | 仅索引 |
| [hyperfx-ai/marketing-skills](https://github.com/hyperfx-ai/marketing-skills) | 87 | 面向营销的 Agent Skills（广告/社媒/SEO/邮件等），配合 Hyper MCP 工具背包 | MIT | 0 | 仅索引 |
| [eldermoraes/quarkus-agentic-scaffolding](https://github.com/eldermoraes/quarkus-agentic-scaffolding) | 26 | Quarkus + LangChain4j 智能体脚手架技能与约定（CLAUDE.md/AGENTS.md） | MIT | 3 | 仅索引 |
| [Jobo16/ielts-buddy](https://github.com/Jobo16/ielts-buddy) | 21 | 雅思学习本地 Agent Skills：计划、作文批改、口语陪练、听力阅读复盘与模考 | MIT | 0 | 仅索引 |
| [JellyBrick/korean-prose-skill](https://github.com/JellyBrick/korean-prose-skill) | 20 | 韩语撰写与校对 Agent Skill，清理翻译腔与不自然文风 | Unknown | 1 | 仅索引 |
| [CodeAlive-AI/codealive-skills](https://github.com/CodeAlive-AI/codealive-skills) | 14 | CodeAlive 语义代码搜索与代码库问答的官方 Agent Skills / 插件 | MIT | 1 | 仅索引 |
| [OpenGHz/embodied-ai-paper-writer](https://github.com/OpenGHz/embodied-ai-paper-writer) | 14 | 具身智能顶会论文写作便携 Agent Skill（SKILL.md + 参考剧本） | MIT | 1 | 仅索引 |
| [axisrobo/ea-harness](https://github.com/axisrobo/ea-harness) | 12 | 企业架构设计与校验技能包/CLI（需求、设计、图表校验与门禁） | MIT | 0 | 仅索引 |
| [mixocreative/ecommerce-cia](https://github.com/mixocreative/ecommerce-cia) | 12 | 台湾电商金流串接与完整性审查 AI skill（蓝新/绿界等），支持 Claude/Codex/Cursor | MIT | 1 | 仅索引 |
| [romainsimon/skills-for-decision-making](https://github.com/romainsimon/skills-for-decision-making) | 11 | 基于《Algorithms for Decision Making》的决策理论 Agent Skills 与计算器 | MIT | 8 | 仅索引 |
| [ponomr/thinking-toolkit](https://github.com/ponomr/thinking-toolkit) | 10 | 30 个思维模型打包为可移植 Agent Skill（决策矩阵/因果图/预检表等），纯 Markdown 零依赖。 | README 未单列 SPDX | 1（含 30 模型） | 仅索引 |
| [anilcancakir/laravel-ai-sdk-skills](https://github.com/anilcancakir/laravel-ai-sdk-skills) | 25 | Laravel AI SDK 的可复用能力系统：用 SKILL.md 定义代理技能并接入 Laravel 应用。 | MIT | 技能系统/多技能 | 仅索引 |
| [dzcmemory-web/bazi-ziwei-skills](https://github.com/dzcmemory-web/bazi-ziwei-skills) | 27 | 八字+紫微斗数排盘与印证 Skill（mingpan/iztro）：算法排盘与水墨风 HTML 海报，兼容多 Agent。 | README 未单列 SPDX | 约 2+ | 仅索引 |
| [alvindemesadev/boring-engineering](https://github.com/alvindemesadev/boring-engineering) | 11 | 反过度工程 SKILL.md：把 KISS/YAGNI/DRY 落成可执行决策系统，适用于多编码代理。 | README 未单列 SPDX | 1 | 仅索引 |
| [anasfik/FlutterGuard](https://github.com/anasfik/FlutterGuard) | 25 | Flutter APK/AAB 安全审计 Agent Skill：面向 OpenClaw/Codex/Claude Code 等的防御性检查清单。 | README 未单列 SPDX | 1 | 仅索引 |
| [ericluo04/claude-academic-workflow](https://github.com/ericluo04/claude-academic-workflow) | 13 | 学术研究工作流约 20 技能：因果推断、文献、Bib 审计、复现包、LaTeX/TikZ、Quarto 幻灯片门禁。 | README 未单列 SPDX | 约 20 | 仅索引 |
| [maton-ai/api-gateway-skill](https://github.com/maton-ai/api-gateway-skill) | 29 | 托管鉴权 API 网关 Skill：一键把代理接到 Slack/HubSpot/Salesforce/Google Workspace 等。 | README 未单列 SPDX | 1 + 插件 | 仅索引 |
| [johnnydecimal/skills](https://github.com/johnnydecimal/skills) | 10 | Johnny.Decimal 文件组织体系的 Agent Skills，帮助代理按 JD 编号管理资料。 | README 未单列 SPDX | 少量 | 仅索引 |
| [netresearch/docker-development-skill](https://github.com/netresearch/docker-development-skill) | 22 | Netresearch Docker 开发 Skill：Dockerfile 最佳实践、CI 测试与 Compose 编排模式。 | README 未单列 SPDX | 1 | 仅索引 |
| [uxKero/anydesign](https://github.com/uxKero/anydesign) | 190 | 从图片/网站/Figma 提取设计系统并生成 design.md（token、组件清单、重建笔记）的 Claude Skill。 | README 未单列 SPDX | 1 | 仅索引 |
| [xr843/Master-skill](https://github.com/xr843/Master-skill) | 394 | FoJin 驱动的佛教 AI 人格框架 Skill：源典 grounding、边界意识与保真测试，可运行。 | README 未单列 SPDX | 人格/技能包 | 仅索引 |
| [guramzhgamadze/WordPress-Elementor-Skill](https://github.com/guramzhgamadze/WordPress-Elementor-Skill) | 25 | WordPress + Elementor Pro 生产级开发标准 Skill：插件/组件/REST/性能实践。 | README 未单列 SPDX | 1 | 仅索引 |
| [maxrave-dev/kotlin-footguns](https://github.com/maxrave-dev/kotlin-footguns) | 387 | 从生产级音乐 App 提炼的 Kotlin/Compose Multiplatform/桌面 JVM 踩坑 Agent Skills（约 224）。 | GPL-3.0 | 约 224 | 仅索引 |
| [jentic/jentic-api-scorecard](https://github.com/jentic/jentic-api-scorecard) | 21 | OpenAPI AI 就绪度评分：CLI/GitHub Action + Agent Skills，输出 HTML 与 Overlay。 | README 未单列 SPDX | 含 agent skills | 仅索引 |
| [tigerless-labs/seo-ops](https://github.com/tigerless-labs/seo-ops) | 236 | SEO 基础结构检查 Agent Skill：给 URL 做 26 项确定性 crawler 视角 pass/fail 报告，零 LLM。 | README 未单列 SPDX | 1 + 26 checks | 仅索引 |
| [ZSeven-W/craft-skills](https://github.com/ZSeven-W/craft-skills) | 153 | 研究驱动/评测驱动设计向 Skills：Logo 语义融合、日记漫画、透明图生成、微缩流程剧场等。 | README 未单列 SPDX | 约 4 | 仅索引 |
| [GENEXIS-AI/gpt-image-skill](https://github.com/GENEXIS-AI/gpt-image-skill) | 166 | 用 ChatGPT 订阅在 Codex/Claude Code 等本地代理中生成/编辑 GPT 图像（不走 Images API 单独计费）。 | README 未单列 SPDX | 1 | 仅索引 |
| [yaojingang/GEOHub](https://github.com/yaojingang/GEOHub) | 161 | 开源 GEO/SEO Agent Skill Hub：发现、诊断、内容、度量与策略优化等协议化技能包。 | README 未单列 SPDX | 约 8+ | 仅索引 |
| [zenstory-ai/oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 346 | DeepSeek Harness 社区插件：小说/短剧/互动游戏/视频解说创作 Skills 与工作台（非 DeepSeek 官方）。 | MIT | 多工作台技能 | 仅索引 |
| [Alexwtlf/agentic-product-demo](https://github.com/Alexwtlf/agentic-product-demo) | 249 | 用编码代理 + Remotion 做产品演示视频的 Agent Skill：UI 是代码而非录屏。 | README 未单列 SPDX | 1 | 仅索引 |
...
| [Spark-To-Paper-Skills/paperjury](https://github.com/Spark-To-Paper-Skills/paperjury) | 1,188 | PaperJury：论文投稿前 AI 评审压力测试 Claude Code skill（due-process）。 | MIT | 1 | 仅索引 |
| [jwangkun/claude-for-financial-services-cn](https://github.com/jwangkun/claude-for-financial-services-cn) | 748 | Anthropic 金融服务 Skills 的 A 股/国内市场深度适配（63 skills）。 | NOASSERTION | 63 | 仅索引 |
| [arnabbagxd/Brand-building-skills](https://github.com/arnabbagxd/Brand-building-skills) | 657 | 品牌建设 Agent Skills：策略/命名/身份/声音/定位/信息与发布。 | MIT | 多 | 仅索引 |
| [addsumtech/slides_maker](https://github.com/addsumtech/slides_maker) | 518 | slide-maker：把论文/代码/文档变成可编辑 PPTX 的 Agent Skill。 | MIT | 1 | 仅索引 |
| [tryproduck/produck-skills](https://github.com/tryproduck/produck-skills) | 511 | 以用户体验为中心的产品构建 Agent Skills 文档驱动集合。 | Apache-2.0 | 多 | 仅索引 |
| [iart-ai/motion-skills](https://github.com/iart-ai/motion-skills) | 463 | 50+ 动效/动画/视频 Agent Skills（14–15 可安装包，Remotion/Manim/WebGL）。 | MIT | 50+ | 仅索引 |
| [cookiy-ai/sell-sessions-skill](https://github.com/cookiy-ai/sell-sessions-skill) | 210 | 出售/打包 Claude Code 与 Codex 会话的开源 Skill。 | MIT | 1 | 仅索引 |
| [sergebulaev/instagram-skills](https://github.com/sergebulaev/instagram-skills) | 94 | Instagram 营销 Agent Skills（9）：文案/Reels hooks/标签/轮播与周计划，approve-before-publish。 | MIT | 9 | 仅索引 |
| [sergebulaev/facebook-skills](https://github.com/sergebulaev/facebook-skills) | 43 | Facebook Pages 营销 Agent Skills（8）：发帖/互动回复/周计划，linkedin-skills 同系。 | MIT | 8 | 仅索引 |
| [sergebulaev/threads-skills](https://github.com/sergebulaev/threads-skills) | 41 | Threads 营销 Agent Skills（8）：帖子/多帖线程/hooks/回复与周计划。 | MIT | 8 | 仅索引 |
| [sergebulaev/tiktok-skills](https://github.com/sergebulaev/tiktok-skills) | 38 | TikTok 营销 Agent Skills（8）：3 秒钩子脚本/字幕/趋势与周计划（不生成视频）。 | MIT | 8 | 仅索引 |
| [sergebulaev/youtube-skills](https://github.com/sergebulaev/youtube-skills) | 31 | YouTube/Shorts 营销 Agent Skills（9）：高 CTR 标题/SEO 描述/留存钩子/缩略图简报。 | MIT | 9 | 仅索引 |
| [lbiz-partners/hometax-doum](https://github.com/lbiz-partners/hometax-doum) | 51 | 韩国 HomeTax 税务助手技能 6 种：增值税/综合所得税/电子发票等，面向小商户口语化引导。 | Other | 6 | 仅索引 |
| [axelfreeman/marketing-mindset](https://github.com/axelfreeman/marketing-mindset) | 31 | 营销心智 OS 单技能：量门槛/淘汰规则/定位与出价决策，而非文案模板库。 | MIT | 1 | 仅索引 |
| [VonTerraProject501c3/slushpile](https://github.com/VonTerraProject501c3/slushpile) | 22 | 对抗式求职技能包：池化匹配打分、简历/求职信、七评审盲审后再合成，本地可安装。 | MIT | 10+ | 仅索引 |
| [upex-galaxy/agentic-qa-boilerplate](https://github.com/upex-galaxy/agentic-qa-boilerplate) | 22 | Agentic QA 样板：Playwright+KATA+agentskills.io 多技能覆盖规划/在测/回归与 GO/NO-GO。 | MIT | 多技能 | 仅索引 |
...
| [alirezarezvani/claude-code-skill-factory](https://github.com/alirezarezvani/claude-code-skill-factory) | 858 | Claude Code Skill 工厂/生成与部署工具包。 | MIT | 8 | 仅索引 |
| [darkrishabh/agent-skills-eval](https://github.com/darkrishabh/agent-skills-eval) | 724 | agentskills.io 风格技能评测运行器。 | MIT | 8 | 仅索引 |
| [majiayu000/claude-skill-registry](https://github.com/majiayu000/claude-skill-registry) | 593 | Claude Code skills 注册表/检索。 | MIT | 4 | 仅索引 |
| [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) | 401 | 科学 Agent Skills 向量检索 MCP。 | Apache-2.0 | 多 | 仅索引 |
| [tobihagemann/turbo](https://github.com/tobihagemann/turbo) | 402 | 可组合 agent 开发流程（Claude/Codex 双版本 modular skills） | MIT | 多 | 仅索引 |
| [initializ/forge](https://github.com/initializ/forge) | 227 | Anthropic Agent Skills 标准的开源安全便携运行时 | Apache-2.0 | 运行时 | 仅索引 |
| [luna-prompts/skillnote](https://github.com/luna-prompts/skillnote) | 61 | 开源 Skill 注册表：创建/管理/分发 SKILL.md 跨多 Agent | MIT | 注册表 | 仅索引 |
| [Berserk-hub150/skillhawk](https://github.com/Berserk-hub150/skillhawk) | 28 | Agent Skills/SKILL.md/MCP 配置安全扫描器（防御向） | MIT | 工具 | 仅索引 |
| [hussi9/skill-router](https://github.com/hussi9/skill-router) | 21 | 按任务自动路由 Skill/Agent/模型/思考深度的元 Skill | MIT | 1 | 仅索引 |
| [gtrabanco/agentic-workflow](https://github.com/gtrabanco/agentic-workflow) | 21 | 栈无关的 agentic 编程工作流 Skills + 文档脚手架 | MIT | 多 | 仅索引 |
| [zernie/vigiles](https://github.com/zernie/vigiles) | 15 | Agent harness 体检：校验 CLAUDE.md/AGENTS.md/skills/hooks | MIT | 工具 | 仅索引 |
| [pdugan20/claudelint](https://github.com/pdugan20/claudelint) | 12 | Claude Code 项目 linter（CLAUDE.md/skills/settings/hooks） | MIT | 工具 | 仅索引 |
| [moatazhamada/ai-omni-skills](https://github.com/moatazhamada/ai-omni-skills) | 12 | 跨工具统一分发与同步 Agent Skills 的源包 | MIT | 15 | 仅索引 |
| [MSiccDev/ai-context-kit](https://github.com/MSiccDev/ai-context-kit) | 12 | AGENTS-first / skills-first 上下文协作框架与模板 | MIT | 多 | 仅索引 |
| [EvolveHQ/docflow](https://github.com/EvolveHQ/docflow) | 11 | ADR 驱动文档工作流 Skills（Claude Code / pi） | MIT | 多 | 仅索引 |
| [mksglu/context-mode](https://github.com/mksglu/context-mode) | 20,840 | 跨 17+ 平台的上下文窗口优化插件：沙箱工具输出、会话记忆与路由，附带一组 ctx-* Agent Skills | Elastic-2.0 | 8 | 仅索引 |
| [instavm/open-skills](https://github.com/instavm/open-skills) | 452 | 本地沙箱运行 Claude Skills 的 MCP 运行时（原 BandarLabs/open-skills），可导入官方/自定义 SKILL.md | Apache-2.0 | 运行时+示例 | 仅索引 |
| [avibe-bot/askill](https://github.com/avibe-bot/askill) | 13 | Agent Skills 包管理器（版本/依赖/安全评分），Show HN Askill | MIT | 包管理器 | 仅索引 |
| [ooocooc/open-skill-sunset](https://github.com/ooocooc/open-skill-sunset) | 87 | 只读审计过期 AGENTS.md/CLAUDE.md/通用 SKILL.md 指令 | Unknown | 工具 | 仅索引 |
| [netresearch/skill-repo-skill](https://github.com/netresearch/skill-repo-skill) | 18 | 技能仓库结构与多渠道分发指南 Skill | Unknown | 1 | 仅索引 |
| [lattebbrook/agent-skiller](https://github.com/lattebbrook/agent-skiller) | 28 | 可视化逐步编排 Agent Skills 的开源构建器 | Unknown | 工具 | 仅索引 |
| [bshea-1/Routed](https://github.com/bshea-1/Routed) | 19 | 跨 AI 编码环境的本地通用 Agent Skills 路由器 | Unknown | 工具 | 仅索引 |
| [alifurkangokce/driftlint](https://github.com/alifurkangokce/driftlint) | 40 | 检测 CLAUDE.md/AGENTS.md/skills 声明与代码漂移的零配置检查器 | Unknown | 工具 | 仅索引 |
...
| [Gentleman-Programming/gentle-ai](https://github.com/Gentleman-Programming/gentle-ai) | 6,620 | 跨代理工程环境配置器：持久记忆/Spec-DD/精选技能/MCP/人设 | MIT | 多 | 仅索引 |
| [romiluz13/cc10x](https://github.com/romiluz13/cc10x) | 164 | Claude Code Loop Engine：1 路由·9 代理·16 skills·4 工作流 | Unknown | 约 16 | 仅索引 |
...
| [william-garden/sync-skill](https://github.com/william-garden/sync-skill) | 185 | 一键在多款编码代理/IDE 间同步 SKILL.md 技能目录的安装器 | MIT | 1 | 仅索引 |
| [Tencent/SkillHone](https://github.com/Tencent/SkillHone) | 151 | 腾讯开源：基于持久决策历史的持续 Agent Skill 演化与优化运行时 | MIT | 0 | 仅索引 |
| [SpaceZephyr/build-your-harness](https://github.com/SpaceZephyr/build-your-harness) | 48 | 三个配套 harness 搭建/体检/翻阅 Agent Skills，零依赖、多运行时通用 | MIT | 3 | 仅索引 |
| [dltsum/doc2skill](https://github.com/dltsum/doc2skill) | 21 | 将操作手册/文档自动转化为高质量 Agent Skills（SKILL.md + references）的工具 | MIT | 1 | 仅索引 |
| [RiriXt1/skillcheck](https://github.com/RiriXt1/skillcheck) | 18 | Agent Skills（SKILL.md）静态检查器：前置元数据、密钥泄露、重名与模糊触发 | MIT | 1 | 仅索引 |
| [theinfosecguy/razin](https://github.com/theinfosecguy/razin) | 16 | 面向 SKILL.md 的本地静态分析安全扫描器（确定性发现，不执行技能代码） | MIT | 1 | 仅索引 |
| [himself65/skill-lint](https://github.com/himself65/skill-lint) | 15 | 校验 Claude/Agent Skills（SKILL.md）的 lint 工具 | MIT | 1 | 仅索引 |
| [KnoxOps/agent-runbook](https://github.com/KnoxOps/agent-runbook) | 13 | 将契约式 YAML runbook 编译为 Claude/Codex SKILL.md 的多代理框架 | MIT | 1 | 仅索引 |
| [Nagi-ovo/dsh-find-plugins](https://github.com/Nagi-ovo/dsh-find-plugins) | 172 | DSH Skill：按自然语言从 GitHub dsh-plugin topic 发现、解释、安装并验证插件。 | README 未单列 SPDX | 1 | 仅索引 |
| [kina-cmd/agent-skill-sync](https://github.com/kina-cmd/agent-skill-sync) | 14 | 跨 Codex/Claude/WorkBuddy 扫描分类并同步 SKILL.md 的零依赖 Python CLI（skillsync）。 | MIT | 安装器/同步器 | 仅索引 |
| [krishyaid-coder/doodle](https://github.com/krishyaid-coder/doodle) | 25 | Claude SKILL.md linter：捕获模糊描述、体量过大与触发失败，帮助技能真正开火。 | README 未单列 SPDX | 工具 | 仅索引 |
| [vanillagreencom/kendex](https://github.com/vanillagreencom/kendex) | 76 | Agent/skills/hooks/扩展的包管理器：一次编写、多 harness 安装的桌面端+CLI。 | README 未单列 SPDX | 包管理器 | 仅索引 |
| [byronxlg/skillfold](https://github.com/byronxlg/skillfold) | 12 | Claude Code/Codex 声明式技能管理：YAML 声明 + lockfile 钉版本，可复现安装到 .claude/skills。 | README 未单列 SPDX | 安装器 | 仅索引 |
| [Zandereins/schliff](https://github.com/Zandereins/schliff) | 16 | AGENTS.md/SKILL.md 等指令文件的确定性质量评分器（8 维+安全），零依赖。 | MIT | 工具 | 仅索引 |
| [ianustec/openwebui-skill-creator](https://github.com/ianustec/openwebui-skill-creator) | 10 | Open WebUI Tool：访谈→起草→校验→持久化 Workspace Skill（SKILL.md），默认私有。 | MIT | 创建器 | 仅索引 |
...
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 94,054 | claude-mem：跨会话持久上下文记忆（捕获 agent 全程活动）。 | Apache-2.0 | 记忆 | 仅索引 |
| [refly-ai/refly](https://github.com/refly-ai/refly) | 7,502 | Refly：用 vibe workflow 定义/运行 Agent Skills 的开源构建器。 | NOASSERTION | 构建器 | 仅索引 |
| [LearnPrompt/luban-skill](https://github.com/LearnPrompt/luban-skill) | 952 | 鲁班：把可用 Skill 打磨成可安装/可传播/可验证/可进化公共资产的工坊。 | MIT | 工坊 | 仅索引 |
| [raiyanyahya/recall](https://github.com/raiyanyahya/recall) | 752 | Recall：Claude Code 本地项目记忆，减少跨会话重复解释。 | MIT | 记忆 | 仅索引 |
| [modiqo/skillspec](https://github.com/modiqo/skillspec) | 742 | SkillSpec：让 Agent Skills 可遵循、可测试、可证明（Doctor 风险报告）。 | NOASSERTION | 规范/评测 | 仅索引 |
| [JayPokale/Chisle](https://github.com/JayPokale/Chisle) | 431 | Chisle：压缩 agent 话语/代码/工具输出以省 token 的跨平台工具。 | MIT | 工具 | 仅索引 |
| [arbiterForge/codeArbiter](https://github.com/arbiterForge/codeArbiter) | 145 | codeArbiter：跨 Claude/Codex/Pi 的仓库级治理与硬门禁层。 | AGPL-3.0 | 治理 | 仅索引 |
...
| [nagisanzenin/engram](https://github.com/nagisanzenin/engram) | 1,422 | Engram：基于证据的学习引擎（课程/回忆验证/FSRS），可作 agent skill。 | MIT | 引擎 | 仅索引 |
| [snflkd/fluent-korean](https://github.com/snflkd/fluent-korean) | 1,291 | fluent-korean：让 Claude Code 输出清晰流利韩语的 output-style 插件。 | MIT | 1 | 仅索引 |
| [alexgreensh/attention-span](https://github.com/alexgreensh/attention-span) | 1,094 | Attention Span：ADHD 友好的 agent 输出风格包（Claude/Codex 等）。 | AGPL-3.0 | 风格 | 仅索引 |
| [fivetaku/fablize](https://github.com/fivetaku/fablize) | 896 | Fablize：让 Claude 像 Fable 一样强调完成/证据/验证的插件。 | MIT | 插件 | 仅索引 |
| [seyedehsanhadi/sloptrim](https://github.com/seyedehsanhadi/sloptrim) | 210 | sloptrim：本地 AI 写作腔调检测器（Claude Code 插件，零依赖）。 | Apache-2.0 | 插件 | 仅索引 |
| [codingSamss/all-my-ai-needs](https://github.com/codingSamss/all-my-ai-needs) | 12 | Claude Code + Codex 双平台 dotfiles：统一管理 skills/agents/hooks。 | NOASSERTION | dotfiles | 仅索引 |
| [aaddrick/attention-control](https://github.com/aaddrick/attention-control) | 111 | 面向 ADHD 读者的代理输出纪律技能/插件：空管式字段化回复（ACTION/EDIT/STATE/NEXT）。 | MIT | 插件 | 仅索引 |
| [MrMarudi/academy-coach](https://github.com/MrMarudi/academy-coach) | 22 | Claude Academy 实操教练插件：academy-learn + academy-review 两技能对照官方最佳实践。 | MIT | 2 | 仅索引 |
...
| [QuZhan51496/paper2anything](https://github.com/QuZhan51496/paper2anything) | 406 | 论文 PDF 转幻灯/海报等的技能包。 | Apache-2.0 | 5 | 仅索引 |
| [panggungunvibe/atutun-xhs-cover](https://github.com/panggungunvibe/atutun-xhs-cover) | 393 | 闃垮洡鍥ら鏍煎皬绾功灏侀潰鎻愮ず璇嶇敓鎴?skill | 其他 | 多 | 仅索引 |
| [i18next/i18next-cli](https://github.com/i18next/i18next-cli) | 235 | i18next 统一高性能 CLI（含 Agent Skills）。 | 其他 | 多 | 仅索引 |
| [bergside/design-md-figma](https://github.com/bergside/design-md-figma) | 149 | Figma plugin that extracts local style guidelines and generates DESIGN… | MIT | 5 | 仅索引 |
| [LcpMarvel/feishu-whiteboard-pro](https://github.com/LcpMarvel/feishu-whiteboard-pro) | 57 | A Claude Code / agent skill for building genuinely designed,… | 其他 | 多 | 仅索引 |
| [jinyh/nsfc-xai-review](https://github.com/jinyh/nsfc-xai-review) | 18 | NSFC AI+鑷劧绉戝浜ゅ弶鏂瑰悜鍩洪噾鐢宠涔﹀嚱璇勮嚜鏌?Skill | 其他 | 多 | 仅索引 |
| [avelikiy/great_cto](https://github.com/avelikiy/great_cto) | 89 | great_cto：把 Claude Code 跑成 70 专家流水线的治理/门禁 harness。 | MIT | 70 agents | 仅索引 |

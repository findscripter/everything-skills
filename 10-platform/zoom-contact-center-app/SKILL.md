...
title: Zoom Contact Center SDK - Web
...
triggers: [Zoom Contact Center, ZCC, contact center sdk, getEngagementContext, onEngagementStatusChange, Smart Embed CRM softphone]
tags: [zoom, contact center, web sdk, android, ios, engagement, softphone]
level: intermediate
status: stable

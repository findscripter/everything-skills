...
domain: 平台/cloud
triggers: [Cloud Run, gcloud run deploy, Cloud Run Functions, Cloud Functions gen2, cpu-boost, min-instances, Secret Manager]
tags: [gcp, cloud run, serverless, pub/sub, cloud sql, secret manager, devops]
level: intermediate
status: stable

...
domain: 平台/mcp
triggers: [zoom mcp, zoom mcp server, zoom mcp tools, zoom tools/list, zoom tools/call, ai companion transcript, agentic retrieval, search_meetings, recordings_list, get_meeting_assets, get_recording_resource, zoom docs mcp]
tags: [zoom, mcp, oauth]
level: intermediate
status: stable

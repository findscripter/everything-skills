...
title: MACS3 — ChIP-seq and ATAC-seq Peak Caller
...
domain: 领域/science
triggers: [MACS3, call peak, callpeak, ChIP-seq, ATAC-seq, narrowPeak, broadPeak, CUT&RUN, CUT&TAG, summits]
tags: [chip-seq, atac-seq, macs3, science]
level: intermediate
status: stable

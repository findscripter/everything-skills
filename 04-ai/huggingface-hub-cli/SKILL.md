...
title: Huggingface Hub Cli
description: Use the Hugging Face Hub CLI (`hf`) to download, upload, and manage models, datasets, and Spaces.
domain: 智能/model-ops
triggers: [hf CLI, huggingface, hf download, hf upload, Hugging Face Hub, hf auth login, huggingface-cli]
tags: [huggingface, cli, mlops, ai/misc]
level: intermediate
status: stable

...
title: Spline 3D Integration Skill
...
domain: 创意/design
triggers: [Spline, spline.design, splinecode, spline-viewer, react-spline, @splinetool/runtime, vue-spline]
tags: [3d, spline, react, next.js, vue, webgl]
level: intermediate
status: stable

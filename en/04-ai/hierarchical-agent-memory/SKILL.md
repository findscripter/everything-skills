...
title: Hierarchical Agent Memory (HAM)
...
domain: 智能/agents
triggers: [go ham, ham, hierarchical memory, CLAUDE.md, scoped memory, reduce token, context routing, ham dashboard, ham savings, ham audit, ham route, .memory, directory-scoped context]
tags: [claude.md, ham]
level: intermediate
status: stable

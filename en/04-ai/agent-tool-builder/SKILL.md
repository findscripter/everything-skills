...
domain: 智能/agents
triggers: [function calling, tool schema, MCP server, MCP tool, tool_use, input_schema, tool_result]
tags: [agents, function-calling, tool-schema, mcp, json-schema, tool-validation, error-handling, anthropic-sdk]
level: intermediate
status: stable

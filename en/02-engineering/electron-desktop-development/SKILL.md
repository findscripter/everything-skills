...
domain: 研发/frontend
triggers: [Electron, contextIsolation, contextBridge, ipcMain, ipcRenderer, electron-builder, electron-forge, electron-updater, BrowserWindow, asar]
tags: [electron, ipc, preload, contextisolation, electron-builder, typescript, misc]
level: intermediate
status: stable

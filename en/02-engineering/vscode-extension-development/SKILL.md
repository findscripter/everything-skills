...
title: VS Code Extension Guide (English)
description: Guide for VS Code extension development from scaffolding to Marketplace publication
domain: 研发/devops
triggers: [vscode extension, yo code, vsce package, vsce publish, Webview, TreeView, activationEvents]
tags: [vscode, extension, ide, typescript, marketplace, devops]
level: intermediate
status: stable

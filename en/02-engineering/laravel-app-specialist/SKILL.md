...
domain: 研发/backend
triggers: [Laravel, Eloquent, Artisan, Blade, API Resource, Sanctum, Horizon, Livewire, Pest, PHPUnit, N+1 eager loading, php artisan]
tags: [laravel, php, eloquent, queue, horizon, sanctum, livewire, api-resource, pest]
level: intermediate
status: stable

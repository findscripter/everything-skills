...
title: Macroeconomic and Rates Monitor
...
domain: 商业/finance
triggers: [yield curve, 2s10s, real rate, breakeven, swap spread]
tags: [finance, macro, rates, yield-curve, inflation, swap-spread, dashboard, mcp]
level: advanced
status: stable

...
title: Bond Relative Value Analysis
...
domain: 商业/finance
triggers: [rich cheap, Z-spread, G-spread, spread decomposition]
tags: [finance, fixed-income, bond, relative-value, spread, scenario-analysis, mcp]
level: advanced
status: stable

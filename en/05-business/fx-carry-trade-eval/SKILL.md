...
domain: 商业/finance
triggers: [carry trade, carry-to-vol, carry to vol, forward points, interest rate differential, vol surface, risk reversal]
tags: [finance, fx, carry-trade, forward-curve, vol-surface, carry-to-vol, mcp]
level: advanced
status: stable

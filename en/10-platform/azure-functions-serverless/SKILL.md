...
domain: 平台/cloud
triggers: [Azure Functions, Durable Functions, azure serverless, function app, isolated worker]
tags: [azure, serverless, azure-functions, durable-functions, isolated-worker, cold-start, dotnet, nodejs, python]
level: intermediate
status: stable

...
domain: 平台/cloud
triggers: [Cloudflare Workers, Wrangler, wrangler.toml, KV, D1, R2, Durable Objects, edge computing, Cloudflare Pages, waitUntil, wrangler dev, wrangler tail]
tags: [misc, cloudflare, workers, serverless, kv, d1, r2, wrangler]
level: intermediate
status: stable

...
domain: 领域/edu
triggers: [professor fit, advisor fit, cold email]
...
- Application type: PhD student, master's student (thesis-track or coursework-track), undergraduate researcher (capstone / thesis / independent study), RA, postdoc, visiting scholar, or research collaborator.
...
Default output language is Traditional Chinese.
...
### Undergraduate researcher (capstone / thesis / independent study)
...
7. Funding databases (NSF Award Search, NIH Reporter, Taiwan MOST grant program, ERC database, Wellcome Trust, CIHR) when visible.

...
title: Pymatgen - Python Materials Genomics
...
domain: 领域/science
triggers: [pymatgen, crystal structure, CIF, POSCAR, phase diagram, band structure, DOS, Materials Project, mp-api, space group]

...
domain: 领域/science
triggers: [UniChem, InChIKey, ChEMBL, DrugBank, PubChem CID, ChEBI, connectivity, source ID, EMBL-EBI]
tags: [science, unichem, rest-api, inchikey]
level: intermediate
status: stable

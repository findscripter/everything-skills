...
title: DrugBank Database — Local XML Access
...
domain: 领域/science
triggers: [DrugBank, DDI, drugbank xml, drug interaction]
tags: [structural-biology-drug-discovery, database, drug-discovery, cheminformatics, xml-parsing]
level: intermediate
status: stable

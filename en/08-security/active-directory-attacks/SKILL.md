...
domain: 安全/appsec
triggers: [Kerberoasting, AS-REP Roasting, DCSync, Pass-the-Hash, Golden Ticket, Silver Ticket, BloodHound, NTLM Relay, Responder, ntlmrelayx, Impacket, Mimikatz, Rubeus, CrackMapExec, ZeroLogon, PrintNightmare, ADCS ESC1, certipy, krbtgt]
tags: [appsec, active-directory, kerberos]
level: advanced
status: stable

...
domain: 通用/thinking
triggers: [execute plan, batch execution, checkpoint, review checkpoint, implementation plan, TodoWrite]
tags: [plan-execution, checkpoints, batch-execution, todowrite, human-in-the-loop, workflow]
level: intermediate
status: stable

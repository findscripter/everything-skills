...
>
> 本库 1108 条中文技能；另索引 **1505** 个外部 GitHub 技能库（只读 README）。
>
...
<details>
<summary>2. 精选列表 / 大集合（collections）（360）</summary>
...
<details>
<summary>3. 垂直领域技能包（vertical）（731）</summary>
